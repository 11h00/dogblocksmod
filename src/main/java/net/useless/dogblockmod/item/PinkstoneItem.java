...
public class PinkstoneItem extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:pinkstone")
	public static final Item block = null;

	public PinkstoneItem(DogblockmodModElements instance) {
		super(instance, 1231);
	}
