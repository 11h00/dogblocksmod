...
public class Starbuck3Item extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:starbuck_3")
	public static final Item block = null;

	public Starbuck3Item(DogblockmodModElements instance) {
		super(instance, 1373);
	}
