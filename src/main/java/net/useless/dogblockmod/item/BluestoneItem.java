...
public class BluestoneItem extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluestone")
	public static final Item block = null;

	public BluestoneItem(DogblockmodModElements instance) {
		super(instance, 1226);
	}
