...
public class PurplestoneItem extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:purplestone")
	public static final Item block = null;

	public PurplestoneItem(DogblockmodModElements instance) {
		super(instance, 1229);
	}
