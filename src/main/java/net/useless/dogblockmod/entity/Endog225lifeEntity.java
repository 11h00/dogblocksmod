...
import net.useless.dogblockmod.procedures.Endog225lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog225lifeRenderer;
...
public class Endog225lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 3.9999999999999996f)).build("endog_225life").setRegistryName("endog_225life");

	public Endog225lifeEntity(DogblockmodModElements instance) {
		super(instance, 1080);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog225lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog225lifeEntityDiesProcedure.executeProcedure(Stream
