...
import net.useless.dogblockmod.entity.renderer.Endog35Renderer;
...
public class Endog35Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_35").setRegistryName("endog_35");

	public Endog35Entity(DogblockmodModElements instance) {
		super(instance, 1256);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog35Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_35_spawn_egg"));
	}
