...
import net.useless.dogblockmod.procedures.Patiencedog12lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog12lifeRenderer;
...
public class Patiencedog12lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_12life").setRegistryName("patiencedog_12life");

	public Patiencedog12lifeEntity(DogblockmodModElements instance) {
		super(instance, 1154);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog12lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog12lifeEntityDiesProcedure.executeProcedure(Stream
