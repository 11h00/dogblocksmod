...
import net.useless.dogblockmod.entity.renderer.Guarddog2Renderer;
...
public class Guarddog2Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 1.9000000000000001f)).build("guarddog_2").setRegistryName("guarddog_2");

	public Guarddog2Entity(DogblockmodModElements instance) {
		super(instance, 972);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Guarddog2Renderer.ModelRegisterHandler());
