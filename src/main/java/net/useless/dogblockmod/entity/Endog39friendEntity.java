...
import net.useless.dogblockmod.entity.renderer.Endog39friendRenderer;
...
public class Endog39friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_39friend").setRegistryName("endog_39friend");

	public Endog39friendEntity(DogblockmodModElements instance) {
		super(instance, 1619);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog39friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_39friend_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.PUMPKIN_PIE));
		}
