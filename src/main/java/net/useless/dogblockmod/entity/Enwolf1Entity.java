...
public class Enwolf1Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_1").setRegistryName("enwolf_1");

	public Enwolf1Entity(DogblockmodModElements instance) {
		super(instance, 1007);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf1Renderer.ModelRegisterHandler());
