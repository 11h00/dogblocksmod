...
import net.useless.dogblockmod.entity.renderer.Friendlycorrupteddog7Renderer;
...
public class Friendlycorrupteddog7Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 1.6f)).build("friendlycorrupteddog_7").setRegistryName("friendlycorrupteddog_7");

	public Friendlycorrupteddog7Entity(DogblockmodModElements instance) {
		super(instance, 1333);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Friendlycorrupteddog7Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092340, -13421569, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("friendlycorrupteddog_7_spawn_egg"));
	}
