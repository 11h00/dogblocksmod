...
import net.useless.dogblockmod.procedures.Babyendog46PlayerCollidesWithThisEntityProcedure;
import net.useless.dogblockmod.procedures.Babyendog46OnInitialEntitySpawnProcedure;
import net.useless.dogblockmod.entity.renderer.Babyendog46Renderer;
...
public class Babyendog46Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 1.2999999999999998f)).build("babyendog_46").setRegistryName("babyendog_46");

	public Babyendog46Entity(DogblockmodModElements instance) {
		super(instance, 1551);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Babyendog46Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711681, -16737895, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("babyendog_46_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public net.minecraft.util.SoundEvent getHurtSound(DamageSource ds) {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dogblockmod:babydogshurt"));
		}

		@Override
		public net.minecraft.util.SoundEvent getDeathSound() {
			return (net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dogblockmod:babydogkilled"));
		}
		...
		public ILivingEntityData onInitialSpawn(IServerWorld world, DifficultyInstance difficulty, SpawnReason reason,
			...
			Babyendog46OnInitialEntitySpawnProcedure.executeProcedure(Stream
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			Babyendog46PlayerCollidesWithThisEntityProcedure.executeProcedure(
