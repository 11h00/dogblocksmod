...
import net.useless.dogblockmod.procedures.Finalbossdog7lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog7lifeRenderer;
...
public class Finalbossdog7lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_7life").setRegistryName("finalbossdog_7life");

	public Finalbossdog7lifeEntity(DogblockmodModElements instance) {
		super(instance, 1121);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog7lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog7lifeEntityDiesProcedure.executeProcedure(Stream
