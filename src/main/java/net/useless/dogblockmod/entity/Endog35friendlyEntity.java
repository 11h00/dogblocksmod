...
import net.useless.dogblockmod.entity.renderer.Endog35friendlyRenderer;
...
public class Endog35friendlyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_35friendly").setRegistryName("endog_35friendly");

	public Endog35friendlyEntity(DogblockmodModElements instance) {
		super(instance, 1257);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog35friendlyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711732, -16763905, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_35friendly_spawn_egg"));
	}
