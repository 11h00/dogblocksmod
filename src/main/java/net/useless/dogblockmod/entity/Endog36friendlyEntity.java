...
import net.useless.dogblockmod.entity.renderer.Endog36friendlyRenderer;
...
public class Endog36friendlyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_36friendly").setRegistryName("endog_36friendly");

	public Endog36friendlyEntity(DogblockmodModElements instance) {
		super(instance, 1260);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog36friendlyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16711732, -16763905, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_36friendly_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 3, (float) 200, false));
