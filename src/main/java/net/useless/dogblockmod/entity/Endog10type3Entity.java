...
import net.useless.dogblockmod.entity.renderer.Endog10type3Renderer;
...
public class Endog10type3Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4000000000000001f, 4.5f)).build("endog_10type_3").setRegistryName("endog_10type_3");

	public Endog10type3Entity(DogblockmodModElements instance) {
		super(instance, 620);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog10type3Renderer.ModelRegisterHandler());
