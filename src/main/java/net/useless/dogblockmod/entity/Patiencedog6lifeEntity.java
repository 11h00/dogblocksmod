...
import net.useless.dogblockmod.procedures.Patiencedog6lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog6lifeRenderer;
...
public class Patiencedog6lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_6life").setRegistryName("patiencedog_6life");

	public Patiencedog6lifeEntity(DogblockmodModElements instance) {
		super(instance, 1148);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog6lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog6lifeEntityDiesProcedure.executeProcedure(Stream
