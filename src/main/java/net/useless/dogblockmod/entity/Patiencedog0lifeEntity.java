...
public class Patiencedog0lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_0life").setRegistryName("patiencedog_0life");

	public Patiencedog0lifeEntity(DogblockmodModElements instance) {
		super(instance, 1142);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog0lifeRenderer.ModelRegisterHandler());
