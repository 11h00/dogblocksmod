...
import net.useless.dogblockmod.entity.renderer.Guarddog1Renderer;
...
public class Guarddog1Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4000000000000001f, 4.5f)).build("guarddog_1").setRegistryName("guarddog_1");

	public Guarddog1Entity(DogblockmodModElements instance) {
		super(instance, 753);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Guarddog1Renderer.ModelRegisterHandler());
