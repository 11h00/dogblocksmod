...
import net.useless.dogblockmod.entity.renderer.Friendlycorrupteddog6Renderer;
...
public class Friendlycorrupteddog6Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 1.5999999999999999f)).build("friendlycorrupteddog_6").setRegistryName("friendlycorrupteddog_6");

	public Friendlycorrupteddog6Entity(DogblockmodModElements instance) {
		super(instance, 1432);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Friendlycorrupteddog6Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -10092340, -13421569, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("friendlycorrupteddog_6_spawn_egg"));
	}
