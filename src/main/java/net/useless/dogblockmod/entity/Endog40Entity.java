...
import net.useless.dogblockmod.entity.renderer.Endog40Renderer;
...
public class Endog40Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_40").setRegistryName("endog_40");

	public Endog40Entity(DogblockmodModElements instance) {
		super(instance, 1467);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog40Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_40_spawn_egg"));
	}
