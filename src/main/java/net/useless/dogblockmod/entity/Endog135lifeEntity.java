...
import net.useless.dogblockmod.procedures.Endog135lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog135lifeRenderer;
...
public class Endog135lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_135life").setRegistryName("endog_135life");

	public Endog135lifeEntity(DogblockmodModElements instance) {
		super(instance, 1039);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog135lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog135lifeEntityDiesProcedure.executeProcedure(Stream
