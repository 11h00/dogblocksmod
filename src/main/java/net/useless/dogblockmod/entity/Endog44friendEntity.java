...
import net.useless.dogblockmod.entity.renderer.Endog44friendRenderer;
...
public class Endog44friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_44friend").setRegistryName("endog_44friend");

	public Endog44friendEntity(DogblockmodModElements instance) {
		super(instance, 1624);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog44friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_44friend_spawn_egg"));
	}
