...
import net.useless.dogblockmod.entity.renderer.Endog45friendRenderer;
...
public class Endog45friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_45friend").setRegistryName("endog_45friend");

	public Endog45friendEntity(DogblockmodModElements instance) {
		super(instance, 1625);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog45friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_45friend_spawn_egg"));
	}
