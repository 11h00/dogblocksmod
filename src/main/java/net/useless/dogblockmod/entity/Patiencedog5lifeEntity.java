...
import net.useless.dogblockmod.procedures.Patiencedog5lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog5lifeRenderer;
...
public class Patiencedog5lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_5life").setRegistryName("patiencedog_5life");

	public Patiencedog5lifeEntity(DogblockmodModElements instance) {
		super(instance, 1147);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog5lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog5lifeEntityDiesProcedure.executeProcedure(Stream
