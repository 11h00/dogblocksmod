...
import net.useless.dogblockmod.entity.renderer.Endog47friendRenderer;
...
public class Endog47friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_47friend").setRegistryName("endog_47friend");

	public Endog47friendEntity(DogblockmodModElements instance) {
		super(instance, 1627);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog47friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_47friend_spawn_egg"));
	}
