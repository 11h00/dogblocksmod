...
import net.useless.dogblockmod.entity.renderer.Giantdog6Renderer;
...
public class Giantdog6Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.9000000000000001f, 3.1f)).build("giantdog_6").setRegistryName("giantdog_6");

	public Giantdog6Entity(DogblockmodModElements instance) {
		super(instance, 452);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Giantdog6Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("giantdog_6_spawn_egg"));
	}
