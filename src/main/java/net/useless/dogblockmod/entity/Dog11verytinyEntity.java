...
import net.useless.dogblockmod.entity.renderer.Dog11verytinyRenderer;
...
public class Dog11verytinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 1f)).build("dog_11verytiny").setRegistryName("dog_11verytiny");

	public Dog11verytinyEntity(DogblockmodModElements instance) {
		super(instance, 641);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog11verytinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_11verytiny_spawn_egg"));
	}
