...
import net.useless.dogblockmod.procedures.Enwolf14livesEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Enwolf14livesRenderer;
...
public class Enwolf14livesEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_14lives").setRegistryName("enwolf_14lives");

	public Enwolf14livesEntity(DogblockmodModElements instance) {
		super(instance, 1020);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf14livesRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Enwolf14livesEntityDiesProcedure.executeProcedure(Stream
