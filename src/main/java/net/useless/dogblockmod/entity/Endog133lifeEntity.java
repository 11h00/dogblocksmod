...
import net.useless.dogblockmod.procedures.Endog133lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog133lifeRenderer;
...
public class Endog133lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_133life").setRegistryName("endog_133life");

	public Endog133lifeEntity(DogblockmodModElements instance) {
		super(instance, 1037);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog133lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog133lifeEntityDiesProcedure.executeProcedure(Stream
