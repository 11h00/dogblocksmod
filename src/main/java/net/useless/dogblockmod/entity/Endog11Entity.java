...
import net.useless.dogblockmod.entity.renderer.Endog11Renderer;
...
public class Endog11Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("endog_11").setRegistryName("endog_11");

	public Endog11Entity(DogblockmodModElements instance) {
		super(instance, 643);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog11Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_11_spawn_egg"));
	}
