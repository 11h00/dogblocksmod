...
import net.useless.dogblockmod.entity.renderer.Doghater1Renderer;
...
public class Doghater1Entity extends DogblockmodModElements.ModElement {
	...
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			...
			.size(0.5f, 0.5f)).build("projectile_doghater_1").setRegistryName("projectile_doghater_1");

	public Doghater1Entity(DogblockmodModElements instance) {
		super(instance, 1348);
	...
	public static class CustomEntity extends MonsterEntity implements IRangedAttackMob {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 0;
			setNoAI(false);
			setCustomName(new StringTextComponent("ihatedogs2"));
