...
import net.useless.dogblockmod.entity.renderer.Dog6tinyRenderer;
...
public class Dog6tinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 3.4f)).build("dog_6tiny").setRegistryName("dog_6tiny");

	public Dog6tinyEntity(DogblockmodModElements instance) {
		super(instance, 448);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog6tinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_6tiny_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 9.5);
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 40;
			setNoAI(false);
			setCustomName(new StringTextComponent("Unammed dog6"));
