...
import net.useless.dogblockmod.entity.renderer.Giantdog1Renderer;
...
public class Giantdog1Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1.9000000000000001f, 3.1f)).build("giantdog_1").setRegistryName("giantdog_1");

	public Giantdog1Entity(DogblockmodModElements instance) {
		super(instance, 313);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Giantdog1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("giantdog_1_spawn_egg"));
	}
