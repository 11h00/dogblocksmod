...
import net.useless.dogblockmod.procedures.Enwolf12livesEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Enwolf12livesRenderer;
...
public class Enwolf12livesEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_12lives").setRegistryName("enwolf_12lives");

	public Enwolf12livesEntity(DogblockmodModElements instance) {
		super(instance, 1022);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf12livesRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Enwolf12livesEntityDiesProcedure.executeProcedure(Stream
