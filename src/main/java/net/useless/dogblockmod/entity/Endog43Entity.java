...
import net.useless.dogblockmod.entity.renderer.Endog43Renderer;
...
public class Endog43Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_43").setRegistryName("endog_43");

	public Endog43Entity(DogblockmodModElements instance) {
		super(instance, 1470);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog43Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_43_spawn_egg"));
	}
