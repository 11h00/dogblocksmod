...
import net.useless.dogblockmod.entity.renderer.Endog7Renderer;
...
public class Endog7Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1f, 4.699999999999999f)).build("endog_7").setRegistryName("endog_7");

	public Endog7Entity(DogblockmodModElements instance) {
		super(instance, 471);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog7Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_7_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 75;
			setNoAI(false);
			setCustomName(new StringTextComponent("Unamed dog 7"));
