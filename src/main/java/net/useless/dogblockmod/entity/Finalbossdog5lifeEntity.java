...
import net.useless.dogblockmod.procedures.Finalbossdog5lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog5lifeRenderer;
...
public class Finalbossdog5lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_5life").setRegistryName("finalbossdog_5life");

	public Finalbossdog5lifeEntity(DogblockmodModElements instance) {
		super(instance, 1119);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog5lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog5lifeEntityDiesProcedure.executeProcedure(Stream
