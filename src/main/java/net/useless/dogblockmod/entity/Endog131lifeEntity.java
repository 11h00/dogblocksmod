...
import net.useless.dogblockmod.procedures.Endog131lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog131lifeRenderer;
...
public class Endog131lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_131life").setRegistryName("endog_131life");

	public Endog131lifeEntity(DogblockmodModElements instance) {
		super(instance, 1035);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog131lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog131lifeEntityDiesProcedure.executeProcedure(Stream
