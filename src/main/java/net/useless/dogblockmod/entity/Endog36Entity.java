...
import net.useless.dogblockmod.entity.renderer.Endog36Renderer;
...
public class Endog36Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 3.2f)).build("endog_36").setRegistryName("endog_36");

	public Endog36Entity(DogblockmodModElements instance) {
		super(instance, 1258);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog36Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_36_spawn_egg"));
	}
