...
import net.useless.dogblockmod.entity.renderer.Endog8Renderer;
...
public class Endog8Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4000000000000001f, 2.9f)).build("endog_8").setRegistryName("endog_8");

	public Endog8Entity(DogblockmodModElements instance) {
		super(instance, 585);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog8Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_8_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 175;
			setNoAI(false);
			setCustomName(new StringTextComponent("Unamed dog 8"));
