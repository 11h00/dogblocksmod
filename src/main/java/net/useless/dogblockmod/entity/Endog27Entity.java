...
import net.useless.dogblockmod.entity.renderer.Endog27Renderer;
...
public class Endog27Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.3f, 1f)).build("endog_27").setRegistryName("endog_27");

	public Endog27Entity(DogblockmodModElements instance) {
		super(instance, 1109);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog27Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_27_spawn_egg"));
	}
