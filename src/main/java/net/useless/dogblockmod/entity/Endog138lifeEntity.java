...
import net.useless.dogblockmod.procedures.Endog138lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog138lifeRenderer;
...
public class Endog138lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_138life").setRegistryName("endog_138life");

	public Endog138lifeEntity(DogblockmodModElements instance) {
		super(instance, 1042);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog138lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog138lifeEntityDiesProcedure.executeProcedure(Stream
