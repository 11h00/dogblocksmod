...
import net.useless.dogblockmod.procedures.Endog1212lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog1212lifeRenderer;
...
public class Endog1212lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_1212life").setRegistryName("endog_1212life");

	public Endog1212lifeEntity(DogblockmodModElements instance) {
		super(instance, 1046);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog1212lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog1212lifeEntityDiesProcedure.executeProcedure(Stream
