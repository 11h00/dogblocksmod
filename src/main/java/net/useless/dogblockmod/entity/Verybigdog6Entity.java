...
import net.useless.dogblockmod.entity.renderer.Verybigdog6Renderer;
...
public class Verybigdog6Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("verybigdog_6").setRegistryName("verybigdog_6");

	public Verybigdog6Entity(DogblockmodModElements instance) {
		super(instance, 450);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Verybigdog6Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("verybigdog_6_spawn_egg"));
	}
