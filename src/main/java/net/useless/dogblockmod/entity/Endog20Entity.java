...
import net.useless.dogblockmod.entity.renderer.Endog20Renderer;
...
public class Endog20Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_20").setRegistryName("endog_20");

	public Endog20Entity(DogblockmodModElements instance) {
		super(instance, 986);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog20Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_20_spawn_egg"));
	}
