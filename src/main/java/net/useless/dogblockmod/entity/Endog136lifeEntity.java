...
import net.useless.dogblockmod.procedures.Endog136lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog136lifeRenderer;
...
public class Endog136lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_136life").setRegistryName("endog_136life");

	public Endog136lifeEntity(DogblockmodModElements instance) {
		super(instance, 1040);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog136lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog136lifeEntityDiesProcedure.executeProcedure(Stream
