...
import net.useless.dogblockmod.procedures.Finalbossdog1lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog1lifeRenderer;
...
public class Finalbossdog1lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_1life").setRegistryName("finalbossdog_1life");

	public Finalbossdog1lifeEntity(DogblockmodModElements instance) {
		super(instance, 1115);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog1lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog1lifeEntityDiesProcedure.executeProcedure(Stream
