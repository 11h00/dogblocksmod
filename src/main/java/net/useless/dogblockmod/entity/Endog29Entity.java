...
import net.useless.dogblockmod.entity.renderer.Endog29Renderer;
...
public class Endog29Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("endog_29").setRegistryName("endog_29");

	public Endog29Entity(DogblockmodModElements instance) {
		super(instance, 1111);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog29Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_29_spawn_egg"));
	}
