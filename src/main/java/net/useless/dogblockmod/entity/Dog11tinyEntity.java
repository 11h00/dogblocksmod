...
import net.useless.dogblockmod.entity.renderer.Dog11tinyRenderer;
...
public class Dog11tinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2.3000000000000003f)).build("dog_11tiny").setRegistryName("dog_11tiny");

	public Dog11tinyEntity(DogblockmodModElements instance) {
		super(instance, 642);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog11tinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_11tiny_spawn_egg"));
	}
