...
import net.useless.dogblockmod.entity.renderer.Endog18Renderer;
...
public class Endog18Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_18").setRegistryName("endog_18");

	public Endog18Entity(DogblockmodModElements instance) {
		super(instance, 984);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog18Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_18_spawn_egg"));
	}
