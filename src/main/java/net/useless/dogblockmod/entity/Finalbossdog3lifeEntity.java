...
import net.useless.dogblockmod.procedures.Finalbossdog3lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog3lifeRenderer;
...
public class Finalbossdog3lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_3life").setRegistryName("finalbossdog_3life");

	public Finalbossdog3lifeEntity(DogblockmodModElements instance) {
		super(instance, 1117);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog3lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog3lifeEntityDiesProcedure.executeProcedure(Stream
