...
import net.useless.dogblockmod.entity.renderer.Endog17Renderer;
...
public class Endog17Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_17").setRegistryName("endog_17");

	public Endog17Entity(DogblockmodModElements instance) {
		super(instance, 983);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog17Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_17_spawn_egg"));
	}
