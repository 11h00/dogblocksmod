...
import net.useless.dogblockmod.entity.renderer.Endog13reverseRenderer;
...
public class Endog13reverseEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1f, 2.9f)).build("endog_13reverse").setRegistryName("endog_13reverse");

	public Endog13reverseEntity(DogblockmodModElements instance) {
		super(instance, 651);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog13reverseRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_13reverse_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 45);
