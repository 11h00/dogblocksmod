...
import net.useless.dogblockmod.entity.renderer.Endog17friendlyRenderer;
...
public class Endog17friendlyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_17friendly").setRegistryName("endog_17friendly");

	public Endog17friendlyEntity(DogblockmodModElements instance) {
		super(instance, 1617);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog17friendlyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_17friendly_spawn_egg"));
	}
