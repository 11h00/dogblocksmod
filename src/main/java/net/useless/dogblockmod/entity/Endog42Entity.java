...
import net.useless.dogblockmod.entity.renderer.Endog42Renderer;
...
public class Endog42Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_42").setRegistryName("endog_42");

	public Endog42Entity(DogblockmodModElements instance) {
		super(instance, 1469);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog42Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_42_spawn_egg"));
	}
