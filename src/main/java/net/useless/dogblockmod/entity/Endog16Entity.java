...
import net.useless.dogblockmod.entity.renderer.Endog16Renderer;
...
public class Endog16Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_16").setRegistryName("endog_16");

	public Endog16Entity(DogblockmodModElements instance) {
		super(instance, 982);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog16Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_16_spawn_egg"));
	}
