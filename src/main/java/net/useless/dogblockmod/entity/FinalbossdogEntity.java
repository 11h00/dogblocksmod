...
public class FinalbossdogEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog").setRegistryName("finalbossdog");

	public FinalbossdogEntity(DogblockmodModElements instance) {
		super(instance, 1112);
		FMLJavaModLoadingContext.get().getModEventBus().register(new FinalbossdogRenderer.ModelRegisterHandler());
