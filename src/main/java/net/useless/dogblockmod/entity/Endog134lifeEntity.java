...
import net.useless.dogblockmod.procedures.Endog134lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog134lifeRenderer;
...
public class Endog134lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_134life").setRegistryName("endog_134life");

	public Endog134lifeEntity(DogblockmodModElements instance) {
		super(instance, 1038);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog134lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog134lifeEntityDiesProcedure.executeProcedure(Stream
