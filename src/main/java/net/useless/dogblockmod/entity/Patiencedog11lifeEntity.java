...
import net.useless.dogblockmod.procedures.Patiencedog11lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog11lifeRenderer;
...
public class Patiencedog11lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_11life").setRegistryName("patiencedog_11life");

	public Patiencedog11lifeEntity(DogblockmodModElements instance) {
		super(instance, 1153);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog11lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog11lifeEntityDiesProcedure.executeProcedure(Stream
