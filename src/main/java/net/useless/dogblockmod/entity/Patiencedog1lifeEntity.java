...
import net.useless.dogblockmod.procedures.Patiencedog1lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog1lifeRenderer;
...
public class Patiencedog1lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_1life").setRegistryName("patiencedog_1life");

	public Patiencedog1lifeEntity(DogblockmodModElements instance) {
		super(instance, 1143);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog1lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog1lifeEntityDiesProcedure.executeProcedure(Stream
