...
import net.useless.dogblockmod.entity.renderer.Endog39Renderer;
...
public class Endog39Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_39").setRegistryName("endog_39");

	public Endog39Entity(DogblockmodModElements instance) {
		super(instance, 1466);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog39Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_39_spawn_egg"));
	}
