...
import net.useless.dogblockmod.entity.renderer.Engiantdog2Renderer;
...
public class Engiantdog2Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7999999999999999f, 2f)).build("engiantdog_2").setRegistryName("engiantdog_2");

	public Engiantdog2Entity(DogblockmodModElements instance) {
		super(instance, 1102);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Engiantdog2Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -16777216, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("engiantdog_2_spawn_egg"));
	}
