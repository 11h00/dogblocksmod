...
import net.useless.dogblockmod.entity.renderer.Endog40friendRenderer;
...
public class Endog40friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_40friend").setRegistryName("endog_40friend");

	public Endog40friendEntity(DogblockmodModElements instance) {
		super(instance, 1620);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog40friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_40friend_spawn_egg"));
	}
