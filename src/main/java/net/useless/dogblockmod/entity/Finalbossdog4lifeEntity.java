...
import net.useless.dogblockmod.procedures.Finalbossdog4lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog4lifeRenderer;
...
public class Finalbossdog4lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_4life").setRegistryName("finalbossdog_4life");

	public Finalbossdog4lifeEntity(DogblockmodModElements instance) {
		super(instance, 1118);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog4lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog4lifeEntityDiesProcedure.executeProcedure(Stream
