...
import net.useless.dogblockmod.entity.renderer.Endog42friendRenderer;
...
public class Endog42friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_42friend").setRegistryName("endog_42friend");

	public Endog42friendEntity(DogblockmodModElements instance) {
		super(instance, 1622);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog42friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_42friend_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.WHEAT));
		}
