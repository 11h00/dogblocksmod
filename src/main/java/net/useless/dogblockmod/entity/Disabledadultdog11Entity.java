...
import net.useless.dogblockmod.entity.renderer.Disabledadultdog11Renderer;
...
public class Disabledadultdog11Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2.3000000000000003f)).build("disabledadultdog_11").setRegistryName("disabledadultdog_11");

	public Disabledadultdog11Entity(DogblockmodModElements instance) {
		super(instance, 659);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Disabledadultdog11Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("disabledadultdog_11_spawn_egg"));
	}
