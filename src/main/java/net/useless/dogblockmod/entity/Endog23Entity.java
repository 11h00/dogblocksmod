...
import net.useless.dogblockmod.entity.renderer.Endog23Renderer;
...
public class Endog23Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.5f, 4.6f)).build("endog_23").setRegistryName("endog_23");

	public Endog23Entity(DogblockmodModElements instance) {
		super(instance, 1099);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog23Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_23_spawn_egg"));
	}
