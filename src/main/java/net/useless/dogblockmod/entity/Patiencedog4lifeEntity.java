...
import net.useless.dogblockmod.procedures.Patiencedog4lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog4lifeRenderer;
...
public class Patiencedog4lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_4life").setRegistryName("patiencedog_4life");

	public Patiencedog4lifeEntity(DogblockmodModElements instance) {
		super(instance, 1146);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog4lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog4lifeEntityDiesProcedure.executeProcedure(Stream
