...
import net.useless.dogblockmod.entity.renderer.Endog41friendRenderer;
...
public class Endog41friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_41friend").setRegistryName("endog_41friend");

	public Endog41friendEntity(DogblockmodModElements instance) {
		super(instance, 1621);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog41friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_41friend_spawn_egg"));
	}
