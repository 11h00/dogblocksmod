...
import net.useless.dogblockmod.entity.renderer.Endog49friendRenderer;
...
public class Endog49friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_49friend").setRegistryName("endog_49friend");

	public Endog49friendEntity(DogblockmodModElements instance) {
		super(instance, 1629);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog49friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_49friend_spawn_egg"));
	}
