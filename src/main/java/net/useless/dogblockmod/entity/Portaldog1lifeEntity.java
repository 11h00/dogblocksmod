...
import net.useless.dogblockmod.procedures.Portaldog1lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Portaldog1lifeRenderer;
...
public class Portaldog1lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("portaldog_1life").setRegistryName("portaldog_1life");

	public Portaldog1lifeEntity(DogblockmodModElements instance) {
		super(instance, 1062);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Portaldog1lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Portaldog1lifeEntityDiesProcedure.executeProcedure(Stream
