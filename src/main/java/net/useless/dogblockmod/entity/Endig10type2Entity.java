...
import net.useless.dogblockmod.entity.renderer.Endig10type2Renderer;
...
public class Endig10type2Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4000000000000001f, 4.5f)).build("endig_10type_2").setRegistryName("endig_10type_2");

	public Endig10type2Entity(DogblockmodModElements instance) {
		super(instance, 619);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endig10type2Renderer.ModelRegisterHandler());
