...
import net.useless.dogblockmod.procedures.Portaldog5lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Portaldog5lifeRenderer;
...
public class Portaldog5lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("portaldog_5life").setRegistryName("portaldog_5life");

	public Portaldog5lifeEntity(DogblockmodModElements instance) {
		super(instance, 1066);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Portaldog5lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Portaldog5lifeEntityDiesProcedure.executeProcedure(Stream
