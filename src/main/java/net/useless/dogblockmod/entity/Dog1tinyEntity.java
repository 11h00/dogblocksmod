...
import net.useless.dogblockmod.entity.renderer.Dog1tinyRenderer;
...
public class Dog1tinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 1.8f)).build("dog_1tiny").setRegistryName("dog_1tiny");

	public Dog1tinyEntity(DogblockmodModElements instance) {
		super(instance, 309);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog1tinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_1tiny_spawn_egg"));
	}
