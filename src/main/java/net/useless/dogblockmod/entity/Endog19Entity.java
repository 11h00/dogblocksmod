...
import net.useless.dogblockmod.entity.renderer.Endog19Renderer;
...
public class Endog19Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_19").setRegistryName("endog_19");

	public Endog19Entity(DogblockmodModElements instance) {
		super(instance, 985);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog19Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_19_spawn_egg"));
	}
