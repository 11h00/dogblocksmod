...
import net.useless.dogblockmod.entity.renderer.Veryharddog23Renderer;
...
public class Veryharddog23Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.5f, 4.6f)).build("veryharddog_23").setRegistryName("veryharddog_23");

	public Veryharddog23Entity(DogblockmodModElements instance) {
		super(instance, 1113);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Veryharddog23Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -52480, -6750157, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("veryharddog_23_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		protected void dropSpecialItems(DamageSource source, int looting, boolean recentlyHitIn) {
			...
			this.entityDropItem(new ItemStack(Items.GOLDEN_APPLE));
		}
