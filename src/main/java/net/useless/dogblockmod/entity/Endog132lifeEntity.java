...
import net.useless.dogblockmod.procedures.Endog132lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog132lifeRenderer;
...
public class Endog132lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_132life").setRegistryName("endog_132life");

	public Endog132lifeEntity(DogblockmodModElements instance) {
		super(instance, 1036);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog132lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog132lifeEntityDiesProcedure.executeProcedure(Stream
