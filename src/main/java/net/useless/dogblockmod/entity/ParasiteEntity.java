...
import net.useless.dogblockmod.entity.renderer.ParasiteRenderer;
...
public class ParasiteEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7f, 2f)).build("parasite").setRegistryName("parasite");

	public ParasiteEntity(DogblockmodModElements instance) {
		super(instance, 1556);
