...
import net.useless.dogblockmod.procedures.Endog1210lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog1210lifeRenderer;
...
public class Endog1210lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_1210life").setRegistryName("endog_1210life");

	public Endog1210lifeEntity(DogblockmodModElements instance) {
		super(instance, 1044);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog1210lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog1210lifeEntityDiesProcedure.executeProcedure(Stream
