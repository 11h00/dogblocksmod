...
import net.useless.dogblockmod.entity.renderer.Endog10type1Renderer;
...
public class Endog10type1Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.4000000000000001f, 4.5f)).build("endog_10type_1").setRegistryName("endog_10type_1");

	public Endog10type1Entity(DogblockmodModElements instance) {
		super(instance, 618);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog10type1Renderer.ModelRegisterHandler());
