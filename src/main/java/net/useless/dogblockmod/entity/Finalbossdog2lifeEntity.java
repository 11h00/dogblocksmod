...
import net.useless.dogblockmod.procedures.Finalbossdog2lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog2lifeRenderer;
...
public class Finalbossdog2lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_2life").setRegistryName("finalbossdog_2life");

	public Finalbossdog2lifeEntity(DogblockmodModElements instance) {
		super(instance, 1116);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog2lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog2lifeEntityDiesProcedure.executeProcedure(Stream
