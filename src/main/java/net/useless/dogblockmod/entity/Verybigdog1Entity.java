...
import net.useless.dogblockmod.entity.renderer.Verybigdog1Renderer;
...
public class Verybigdog1Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("verybigdog_1").setRegistryName("verybigdog_1");

	public Verybigdog1Entity(DogblockmodModElements instance) {
		super(instance, 311);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Verybigdog1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("verybigdog_1_spawn_egg"));
	}
