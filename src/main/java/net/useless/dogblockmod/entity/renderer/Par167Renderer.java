...
@OnlyIn(Dist.CLIENT)
public class Par167Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Par167Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpar16(), 0f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("dogblockmod:textures/entities/par16_7.png");
					}
				};
			});
		}
