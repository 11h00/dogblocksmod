...
@OnlyIn(Dist.CLIENT)
public class Par164Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Par164Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpar16(), 0f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("dogblockmod:textures/entities/par16_4.png");
					}
				};
			});
		}
