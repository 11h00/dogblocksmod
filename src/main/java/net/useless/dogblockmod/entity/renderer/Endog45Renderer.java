...
import net.useless.dogblockmod.entity.Endog45Entity;
...
@OnlyIn(Dist.CLIENT)
public class Endog45Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Endog45Entity.entity, renderManager -> {
