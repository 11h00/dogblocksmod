...
@OnlyIn(Dist.CLIENT)
public class Enwolf2formathiasbruhRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Enwolf2formathiasbruhEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelwolf2(), 1.4f) {
