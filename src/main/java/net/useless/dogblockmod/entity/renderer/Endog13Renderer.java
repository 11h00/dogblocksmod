...
import net.useless.dogblockmod.entity.Endog13Entity;
...
@OnlyIn(Dist.CLIENT)
public class Endog13Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Endog13Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modeldog13(), 0.5f) {
