...
@OnlyIn(Dist.CLIENT)
public class Par26Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Par26Entity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelpar3(), 0f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("dogblockmod:textures/entities/par3_6.png");
					}
				};
			});
		}
