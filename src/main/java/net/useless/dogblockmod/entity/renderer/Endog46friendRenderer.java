...
import net.useless.dogblockmod.entity.Endog46friendEntity;
...
@OnlyIn(Dist.CLIENT)
public class Endog46friendRenderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Endog46friendEntity.entity, renderManager -> {
				return new MobRenderer(renderManager, new Modelendog46(), 0.5f) {

					@Override
					public ResourceLocation getEntityTexture(Entity entity) {
						return new ResourceLocation("dogblockmod:textures/entities/endog46.png");
					}
	...
	public static class Modelendog46 extends EntityModel<Entity> {
