...
import net.useless.dogblockmod.entity.Endog46Entity;
...
@OnlyIn(Dist.CLIENT)
public class Endog46Renderer {
	public static class ModelRegisterHandler {
		@SubscribeEvent
		@OnlyIn(Dist.CLIENT)
		public void registerModels(ModelRegistryEvent event) {
			RenderingRegistry.registerEntityRenderingHandler(Endog46Entity.entity, renderManager -> {
