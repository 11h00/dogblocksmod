...
import net.useless.dogblockmod.entity.renderer.Endog38friendRenderer;
...
public class Endog38friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_38friend").setRegistryName("endog_38friend");

	public Endog38friendEntity(DogblockmodModElements instance) {
		super(instance, 1618);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog38friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_38friend_spawn_egg"));
	}
