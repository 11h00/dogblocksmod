...
import net.useless.dogblockmod.procedures.Patiencedog2lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog2lifeRenderer;
...
public class Patiencedog2lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_2life").setRegistryName("patiencedog_2life");

	public Patiencedog2lifeEntity(DogblockmodModElements instance) {
		super(instance, 1144);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog2lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog2lifeEntityDiesProcedure.executeProcedure(Stream
