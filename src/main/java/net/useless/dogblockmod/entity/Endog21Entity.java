...
import net.useless.dogblockmod.entity.renderer.Endog21Renderer;
...
public class Endog21Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 0.5f)).build("endog_21").setRegistryName("endog_21");

	public Endog21Entity(DogblockmodModElements instance) {
		super(instance, 1074);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog21Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_21_spawn_egg"));
	}
