...
import net.useless.dogblockmod.procedures.Portaldog4lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Portaldog4lifeRenderer;
...
public class Portaldog4lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("portaldog_4life").setRegistryName("portaldog_4life");

	public Portaldog4lifeEntity(DogblockmodModElements instance) {
		super(instance, 1065);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Portaldog4lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends CreatureEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Portaldog4lifeEntityDiesProcedure.executeProcedure(Stream
