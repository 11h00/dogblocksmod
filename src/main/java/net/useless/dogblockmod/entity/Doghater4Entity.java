...
import net.useless.dogblockmod.entity.renderer.Doghater4Renderer;
...
public class Doghater4Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.CREATURE)
			...
			.size(0.6f, 1.8f)).build("doghater_4").setRegistryName("doghater_4");

	public Doghater4Entity(DogblockmodModElements instance) {
		super(instance, 1406);
