...
import net.useless.dogblockmod.entity.renderer.Endog38Renderer;
...
public class Endog38Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_38").setRegistryName("endog_38");

	public Endog38Entity(DogblockmodModElements instance) {
		super(instance, 1465);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog38Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_38_spawn_egg"));
	}
