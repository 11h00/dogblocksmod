...
import net.useless.dogblockmod.procedures.Endog228lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog228lifeRenderer;
...
public class Endog228lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 3.9999999999999996f)).build("endog_228life").setRegistryName("endog_228life");

	public Endog228lifeEntity(DogblockmodModElements instance) {
		super(instance, 1083);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog228lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog228lifeEntityDiesProcedure.executeProcedure(Stream
