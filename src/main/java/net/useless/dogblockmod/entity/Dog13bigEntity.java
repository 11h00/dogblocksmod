...
import net.useless.dogblockmod.entity.renderer.Dog13bigRenderer;
...
public class Dog13bigEntity extends DogblockmodModElements.ModElement {
	...
	public Dog13bigEntity(DogblockmodModElements instance) {
		super(instance, 652);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog13bigRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_13big_spawn_egg"));
	}
