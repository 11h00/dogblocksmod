...
import net.useless.dogblockmod.entity.renderer.Dog1Renderer;
...
public class Dog1Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1f, 1.9000000000000001f)).build("dog_1").setRegistryName("dog_1");

	public Dog1Entity(DogblockmodModElements instance) {
		super(instance, 308);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog1Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_1_spawn_egg"));
	}
