...
import net.useless.dogblockmod.entity.renderer.Endog14Renderer;
...
public class Endog14Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_14").setRegistryName("endog_14");

	public Endog14Entity(DogblockmodModElements instance) {
		super(instance, 861);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog14Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_14_spawn_egg"));
	}
