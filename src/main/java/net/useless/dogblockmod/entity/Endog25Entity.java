...
import net.useless.dogblockmod.entity.renderer.Endog25Renderer;
...
public class Endog25Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.3f, 1f)).build("endog_25").setRegistryName("endog_25");

	public Endog25Entity(DogblockmodModElements instance) {
		super(instance, 1107);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog25Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_25_spawn_egg"));
	}
