...
public class Endog46Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_46").setRegistryName("endog_46");

	public Endog46Entity(DogblockmodModElements instance) {
		super(instance, 1487);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog46Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_46_spawn_egg"));
	}
