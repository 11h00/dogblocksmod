...
import net.useless.dogblockmod.entity.renderer.Endog34Renderer;
...
public class Endog34Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_34").setRegistryName("endog_34");

	public Endog34Entity(DogblockmodModElements instance) {
		super(instance, 1219);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog34Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_34_spawn_egg"));
	}
