...
import net.useless.dogblockmod.entity.renderer.Endog28Renderer;
...
public class Endog28Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.3f, 1f)).build("endog_28").setRegistryName("endog_28");

	public Endog28Entity(DogblockmodModElements instance) {
		super(instance, 1110);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog28Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_28_spawn_egg"));
	}
