...
import net.useless.dogblockmod.entity.renderer.Endog22Renderer;
...
public class Endog22Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 3.9999999999999996f)).build("endog_22").setRegistryName("endog_22");

	public Endog22Entity(DogblockmodModElements instance) {
		super(instance, 1075);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog22Renderer.ModelRegisterHandler());
