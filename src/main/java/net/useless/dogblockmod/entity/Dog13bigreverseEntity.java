...
import net.useless.dogblockmod.entity.renderer.Dog13bigreverseRenderer;
...
public class Dog13bigreverseEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 6.2f)).build("dog_13bigreverse").setRegistryName("dog_13bigreverse");

	public Dog13bigreverseEntity(DogblockmodModElements instance) {
		super(instance, 653);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog13bigreverseRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(
				() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_13bigreverse_spawn_egg"));
	}
