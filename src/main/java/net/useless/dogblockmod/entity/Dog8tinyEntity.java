...
import net.useless.dogblockmod.entity.renderer.Dog8tinyRenderer;
...
public class Dog8tinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 0.8f)).build("dog_8tiny").setRegistryName("dog_8tiny");

	public Dog8tinyEntity(DogblockmodModElements instance) {
		super(instance, 584);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog8tinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_8tiny_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 40;
			setNoAI(false);
			setCustomName(new StringTextComponent("Unammed dog8"));
