...
import net.useless.dogblockmod.entity.renderer.Dog13tinyRenderer;
...
public class Dog13tinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 1f)).build("dog_13tiny").setRegistryName("dog_13tiny");

	public Dog13tinyEntity(DogblockmodModElements instance) {
		super(instance, 648);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog13tinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_13tiny_spawn_egg"));
	}
