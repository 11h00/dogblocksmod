...
import net.useless.dogblockmod.entity.renderer.Endog37Renderer;
...
public class Endog37Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(70).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new).size(2f, 3.5f))
			.build("endog_37").setRegistryName("endog_37");

	public Endog37Entity(DogblockmodModElements instance) {
		super(instance, 1259);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog37Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_37_spawn_egg"));
	}
