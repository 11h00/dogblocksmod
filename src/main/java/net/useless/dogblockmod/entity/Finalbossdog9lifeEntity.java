...
import net.useless.dogblockmod.procedures.Finalbossdog9lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog9lifeRenderer;
...
public class Finalbossdog9lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_9life").setRegistryName("finalbossdog_9life");

	public Finalbossdog9lifeEntity(DogblockmodModElements instance) {
		super(instance, 1123);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog9lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog9lifeEntityDiesProcedure.executeProcedure(Stream
