...
import net.useless.dogblockmod.entity.renderer.PortaldogRenderer;
...
public class PortaldogEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("portaldog").setRegistryName("portaldog");

	public PortaldogEntity(DogblockmodModElements instance) {
		super(instance, 862);
		FMLJavaModLoadingContext.get().getModEventBus().register(new PortaldogRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("portaldog_spawn_egg"));
	}
