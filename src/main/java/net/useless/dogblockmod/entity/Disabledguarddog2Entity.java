...
import net.useless.dogblockmod.procedures.Disabledguarddog2PlayerCollidesWithThisEntityProcedure;
import net.useless.dogblockmod.entity.renderer.Disabledguarddog2Renderer;
...
public class Disabledguarddog2Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 2.1f)).build("disabledguarddog_2").setRegistryName("disabledguarddog_2");

	public Disabledguarddog2Entity(DogblockmodModElements instance) {
		super(instance, 973);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Disabledguarddog2Renderer.ModelRegisterHandler());
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.ARMOR, 13);
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 25;
			setNoAI(false);
			setCustomName(new StringTextComponent("Disabled guard dog"));
		...
		public double getMountedYOffset() {
			return super.getMountedYOffset() + 0.7999999999999999;
		}
		...
		public void onCollideWithPlayer(PlayerEntity sourceentity) {
			...
			Disabledguarddog2PlayerCollidesWithThisEntityProcedure.executeProcedure(Stream
