...
import net.useless.dogblockmod.entity.renderer.Endog13Renderer;
...
public class Endog13Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("endog_13").setRegistryName("endog_13");

	public Endog13Entity(DogblockmodModElements instance) {
		super(instance, 650);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog13Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_13_spawn_egg"));
	}
