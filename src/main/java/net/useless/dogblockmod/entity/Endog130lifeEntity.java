...
import net.useless.dogblockmod.procedures.Endog130lifeEntityDiesProcedure;
import net.useless.dogblockmod.item.PortalsummonerItem;
import net.useless.dogblockmod.entity.renderer.Endog130lifeRenderer;
...
public class Endog130lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_130life").setRegistryName("endog_130life");

	public Endog130lifeEntity(DogblockmodModElements instance) {
		super(instance, 1034);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog130lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog130lifeEntityDiesProcedure.executeProcedure(Stream
