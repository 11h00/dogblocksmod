...
import net.useless.dogblockmod.entity.renderer.Endog33Renderer;
...
public class Endog33Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_33").setRegistryName("endog_33");

	public Endog33Entity(DogblockmodModElements instance) {
		super(instance, 1216);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog33Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_33_spawn_egg"));
	}
