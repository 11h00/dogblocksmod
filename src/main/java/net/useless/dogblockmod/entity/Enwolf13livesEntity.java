...
import net.useless.dogblockmod.procedures.Enwolf13livesEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Enwolf13livesRenderer;
...
public class Enwolf13livesEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_13lives").setRegistryName("enwolf_13lives");

	public Enwolf13livesEntity(DogblockmodModElements instance) {
		super(instance, 1021);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf13livesRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Enwolf13livesEntityDiesProcedure.executeProcedure(Stream
