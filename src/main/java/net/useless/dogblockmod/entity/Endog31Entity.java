...
import net.useless.dogblockmod.entity.renderer.Endog31Renderer;
...
public class Endog31Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_31").setRegistryName("endog_31");

	public Endog31Entity(DogblockmodModElements instance) {
		super(instance, 1213);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog31Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_31_spawn_egg"));
	}
	...
	private static class EntityAttributesRegisterHandler {
		...
		public void onEntityAttributeCreation(EntityAttributeCreationEvent event) {
			...
			ammma = ammma.createMutableAttribute(Attributes.MAX_HEALTH, 435);
