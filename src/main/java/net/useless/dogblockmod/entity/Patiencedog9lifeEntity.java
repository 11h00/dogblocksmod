...
import net.useless.dogblockmod.procedures.Patiencedog9lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog9lifeRenderer;
...
public class Patiencedog9lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_9life").setRegistryName("patiencedog_9life");

	public Patiencedog9lifeEntity(DogblockmodModElements instance) {
		super(instance, 1151);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog9lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog9lifeEntityDiesProcedure.executeProcedure(Stream
