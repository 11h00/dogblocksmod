...
import net.useless.dogblockmod.procedures.Portaldog3lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Portaldog3lifeRenderer;
...
public class Portaldog3lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("portaldog_3life").setRegistryName("portaldog_3life");

	public Portaldog3lifeEntity(DogblockmodModElements instance) {
		super(instance, 1064);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Portaldog3lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Portaldog3lifeEntityDiesProcedure.executeProcedure(Stream
