...
import net.useless.dogblockmod.entity.renderer.Endog43friendRenderer;
...
public class Endog43friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_43friend").setRegistryName("endog_43friend");

	public Endog43friendEntity(DogblockmodModElements instance) {
		super(instance, 1623);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog43friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_43friend_spawn_egg"));
	}
