...
import net.useless.dogblockmod.entity.renderer.Endog41Renderer;
...
public class Endog41Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_41").setRegistryName("endog_41");

	public Endog41Entity(DogblockmodModElements instance) {
		super(instance, 1468);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog41Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_41_spawn_egg"));
	}
