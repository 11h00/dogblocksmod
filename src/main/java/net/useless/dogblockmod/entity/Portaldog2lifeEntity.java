...
import net.useless.dogblockmod.procedures.Portaldog2lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Portaldog2lifeRenderer;
...
public class Portaldog2lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("portaldog_2life").setRegistryName("portaldog_2life");

	public Portaldog2lifeEntity(DogblockmodModElements instance) {
		super(instance, 1063);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Portaldog2lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Portaldog2lifeEntityDiesProcedure.executeProcedure(Stream
