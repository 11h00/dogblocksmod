...
import net.useless.dogblockmod.entity.renderer.Endog48friendRenderer;
...
public class Endog48friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_48friend").setRegistryName("endog_48friend");

	public Endog48friendEntity(DogblockmodModElements instance) {
		super(instance, 1628);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog48friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_48friend_spawn_egg"));
	}
