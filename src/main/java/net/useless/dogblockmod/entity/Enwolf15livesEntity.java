...
import net.useless.dogblockmod.procedures.Enwolf15livesEntityDiesProcedure;
import net.useless.dogblockmod.itemgroup.StrangedungeonItemGroup;
import net.useless.dogblockmod.entity.renderer.Enwolf15livesRenderer;
...
public class Enwolf15livesEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_15lives").setRegistryName("enwolf_15lives");

	public Enwolf15livesEntity(DogblockmodModElements instance) {
		super(instance, 1019);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf15livesRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -65281, -10092442, new Item.Properties().group(StrangedungeonItemGroup.tab))
				.setRegistryName("enwolf_15lives_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Enwolf15livesEntityDiesProcedure.executeProcedure(Stream
