...
import net.useless.dogblockmod.procedures.Finalbossdog10lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog10lifeRenderer;
...
public class Finalbossdog10lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_10life").setRegistryName("finalbossdog_10life");

	public Finalbossdog10lifeEntity(DogblockmodModElements instance) {
		super(instance, 1124);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog10lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog10lifeEntityDiesProcedure.executeProcedure(Stream
