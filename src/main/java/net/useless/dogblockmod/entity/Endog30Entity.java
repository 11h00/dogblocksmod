...
import net.useless.dogblockmod.entity.renderer.Endog30Renderer;
...
public class Endog30Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("endog_30").setRegistryName("endog_30");

	public Endog30Entity(DogblockmodModElements instance) {
		super(instance, 1212);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog30Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_30_spawn_egg"));
	}
