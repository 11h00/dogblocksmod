...
import net.useless.dogblockmod.procedures.Enwolf11livesEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Enwolf11livesRenderer;
...
public class Enwolf11livesEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_11lives").setRegistryName("enwolf_11lives");

	public Enwolf11livesEntity(DogblockmodModElements instance) {
		super(instance, 1023);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf11livesRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Enwolf11livesEntityDiesProcedure.executeProcedure(Stream
