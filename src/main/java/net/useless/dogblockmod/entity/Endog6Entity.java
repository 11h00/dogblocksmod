...
import net.useless.dogblockmod.entity.renderer.Endog6Renderer;
...
public class Endog6Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(1f, 1.9000000000000001f)).build("endog_6").setRegistryName("endog_6");

	public Endog6Entity(DogblockmodModElements instance) {
		super(instance, 447);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog6Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_6_spawn_egg"));
	}
