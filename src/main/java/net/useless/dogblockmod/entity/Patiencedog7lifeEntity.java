...
import net.useless.dogblockmod.procedures.Patiencedog7lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog7lifeRenderer;
...
public class Patiencedog7lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_7life").setRegistryName("patiencedog_7life");

	public Patiencedog7lifeEntity(DogblockmodModElements instance) {
		super(instance, 1149);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog7lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog7lifeEntityDiesProcedure.executeProcedure(Stream
