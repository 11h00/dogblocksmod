...
import net.useless.dogblockmod.entity.renderer.Endog32Renderer;
...
public class Endog32Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.build("endog_32").setRegistryName("endog_32");

	public Endog32Entity(DogblockmodModElements instance) {
		super(instance, 1215);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog32Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_32_spawn_egg"));
	}
