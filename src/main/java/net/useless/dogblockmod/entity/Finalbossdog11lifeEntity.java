...
import net.useless.dogblockmod.procedures.Finalbossdog11lifeEntityDiesProcedure;
import net.useless.dogblockmod.itemgroup.DogtabItemGroup;
import net.useless.dogblockmod.entity.renderer.Finalbossdog11lifeRenderer;
...
public class Finalbossdog11lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_11life").setRegistryName("finalbossdog_11life");

	public Finalbossdog11lifeEntity(DogblockmodModElements instance) {
		super(instance, 1125);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog11lifeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -16777216, new Item.Properties().group(DogtabItemGroup.tab))
				.setRegistryName("finalbossdog_11life_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog11lifeEntityDiesProcedure.executeProcedure(Stream
