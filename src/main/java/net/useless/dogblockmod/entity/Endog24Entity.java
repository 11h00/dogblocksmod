...
import net.useless.dogblockmod.entity.renderer.Endog24Renderer;
...
public class Endog24Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_24").setRegistryName("endog_24");

	public Endog24Entity(DogblockmodModElements instance) {
		super(instance, 1100);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog24Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_24_spawn_egg"));
	}
