...
import net.useless.dogblockmod.entity.renderer.Resistdog20Renderer;
...
public class Resistdog20Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.4f, 2.9f)).build("resistdog_20").setRegistryName("resistdog_20");

	public Resistdog20Entity(DogblockmodModElements instance) {
		super(instance, 987);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Resistdog20Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("resistdog_20_spawn_egg"));
	}
