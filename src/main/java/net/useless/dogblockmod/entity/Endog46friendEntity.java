...
import net.useless.dogblockmod.entity.renderer.Endog46friendRenderer;
...
public class Endog46friendEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 2f)).build("endog_46friend").setRegistryName("endog_46friend");

	public Endog46friendEntity(DogblockmodModElements instance) {
		super(instance, 1626);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog46friendRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("endog_46friend_spawn_egg"));
	}
