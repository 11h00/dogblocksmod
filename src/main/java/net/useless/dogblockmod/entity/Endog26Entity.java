...
import net.useless.dogblockmod.entity.renderer.Endog26Renderer;
...
public class Endog26Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.3f, 1f)).build("endog_26").setRegistryName("endog_26");

	public Endog26Entity(DogblockmodModElements instance) {
		super(instance, 1108);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog26Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("endog_26_spawn_egg"));
	}
