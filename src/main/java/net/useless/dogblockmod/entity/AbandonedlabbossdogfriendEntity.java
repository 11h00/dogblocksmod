...
import net.useless.dogblockmod.entity.renderer.AbandonedlabbossdogfriendRenderer;
...
public class AbandonedlabbossdogfriendEntity extends DogblockmodModElements.ModElement {
	...
	public AbandonedlabbossdogfriendEntity(DogblockmodModElements instance) {
		super(instance, 1210);
		FMLJavaModLoadingContext.get().getModEventBus().register(new AbandonedlabbossdogfriendRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 4, (float) 200, false));
