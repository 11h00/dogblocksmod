...
import net.useless.dogblockmod.procedures.Patiencedog8lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog8lifeRenderer;
...
public class Patiencedog8lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_8life").setRegistryName("patiencedog_8life");

	public Patiencedog8lifeEntity(DogblockmodModElements instance) {
		super(instance, 1150);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog8lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog8lifeEntityDiesProcedure.executeProcedure(Stream
