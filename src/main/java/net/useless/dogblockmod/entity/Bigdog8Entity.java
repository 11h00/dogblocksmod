...
import net.useless.dogblockmod.entity.renderer.Bigdog8Renderer;
...
public class Bigdog8Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(2.6f, 12.1f)).build("bigdog_8").setRegistryName("bigdog_8");

	public Bigdog8Entity(DogblockmodModElements instance) {
		super(instance, 597);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Bigdog8Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("bigdog_8_spawn_egg"));
	}
