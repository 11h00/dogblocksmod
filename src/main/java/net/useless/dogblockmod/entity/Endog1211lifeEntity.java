...
import net.useless.dogblockmod.procedures.Endog1211lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog1211lifeRenderer;
...
public class Endog1211lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_1211life").setRegistryName("endog_1211life");

	public Endog1211lifeEntity(DogblockmodModElements instance) {
		super(instance, 1045);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog1211lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog1211lifeEntityDiesProcedure.executeProcedure(Stream
