...
import net.useless.dogblockmod.procedures.Endog129lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog129lifeRenderer;
...
public class Endog129lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_129life").setRegistryName("endog_129life");

	public Endog129lifeEntity(DogblockmodModElements instance) {
		super(instance, 1043);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog129lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog129lifeEntityDiesProcedure.executeProcedure(Stream
