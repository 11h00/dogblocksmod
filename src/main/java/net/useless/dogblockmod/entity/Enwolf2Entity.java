...
import net.useless.dogblockmod.entity.renderer.Enwolf2Renderer;
...
public class Enwolf2Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.7000000000000001f, 4.8999999999999995f)).build("enwolf_2").setRegistryName("enwolf_2");

	public Enwolf2Entity(DogblockmodModElements instance) {
		super(instance, 1008);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Enwolf2Renderer.ModelRegisterHandler());
