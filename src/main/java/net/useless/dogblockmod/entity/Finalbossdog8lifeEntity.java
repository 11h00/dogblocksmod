...
import net.useless.dogblockmod.procedures.Finalbossdog8lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog8lifeRenderer;
...
public class Finalbossdog8lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_8life").setRegistryName("finalbossdog_8life");

	public Finalbossdog8lifeEntity(DogblockmodModElements instance) {
		super(instance, 1122);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog8lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog8lifeEntityDiesProcedure.executeProcedure(Stream
