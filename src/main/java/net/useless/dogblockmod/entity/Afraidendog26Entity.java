...
import net.useless.dogblockmod.entity.renderer.Afraidendog26Renderer;
...
public class Afraidendog26Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.3f, 1f)).build("afraidendog_26").setRegistryName("afraidendog_26");

	public Afraidendog26Entity(DogblockmodModElements instance) {
		super(instance, 1114);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Afraidendog26Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16777216, -16777216, new Item.Properties().group(ItemGroup.MISC))
				.setRegistryName("afraidendog_26_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		protected void registerGoals() {
			super.registerGoals();
			this.goalSelector.addGoal(1, new FollowOwnerGoal(this, 1, (float) 5, (float) 550, false));
