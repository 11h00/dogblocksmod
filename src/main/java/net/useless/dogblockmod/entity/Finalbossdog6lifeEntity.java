...
import net.useless.dogblockmod.procedures.Finalbossdog6lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Finalbossdog6lifeRenderer;
...
public class Finalbossdog6lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(1.6f, 1.4000000000000001f)).build("finalbossdog_6life").setRegistryName("finalbossdog_6life");

	public Finalbossdog6lifeEntity(DogblockmodModElements instance) {
		super(instance, 1120);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Finalbossdog6lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Finalbossdog6lifeEntityDiesProcedure.executeProcedure(Stream
