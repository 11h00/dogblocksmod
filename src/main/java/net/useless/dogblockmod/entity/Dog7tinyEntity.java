...
import net.useless.dogblockmod.entity.renderer.Dog7tinyRenderer;
...
public class Dog7tinyEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(3).setCustomClientFactory(CustomEntity::new)
			.size(0.6f, 2.2f)).build("dog_7tiny").setRegistryName("dog_7tiny");

	public Dog7tinyEntity(DogblockmodModElements instance) {
		super(instance, 470);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Dog7tinyRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("dog_7tiny_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 40;
			setNoAI(false);
			setCustomName(new StringTextComponent("Unammed dog7"));
