...
import net.useless.dogblockmod.procedures.Endog137lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Endog137lifeRenderer;
...
public class Endog137lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.3f, 5.5f)).build("endog_137life").setRegistryName("endog_137life");

	public Endog137lifeEntity(DogblockmodModElements instance) {
		super(instance, 1041);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Endog137lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Endog137lifeEntityDiesProcedure.executeProcedure(Stream
