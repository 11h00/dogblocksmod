...
import net.useless.dogblockmod.procedures.Patiencedog13lifeEntityDiesProcedure;
import net.useless.dogblockmod.itemgroup.StrangedungeonItemGroup;
import net.useless.dogblockmod.entity.renderer.Patiencedog13lifeRenderer;
...
public class Patiencedog13lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_13life").setRegistryName("patiencedog_13life");

	public Patiencedog13lifeEntity(DogblockmodModElements instance) {
		super(instance, 1155);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog13lifeRenderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items.add(() -> new SpawnEggItem(entity, -16724890, -39169, new Item.Properties().group(StrangedungeonItemGroup.tab))
				.setRegistryName("patiencedog_13life_spawn_egg"));
	}
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog13lifeEntityDiesProcedure.executeProcedure(Stream
