...
import net.useless.dogblockmod.procedures.Patiencedog10lifeEntityDiesProcedure;
import net.useless.dogblockmod.entity.renderer.Patiencedog10lifeRenderer;
...
public class Patiencedog10lifeEntity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.9f, 3.6f)).build("patiencedog_10life").setRegistryName("patiencedog_10life");

	public Patiencedog10lifeEntity(DogblockmodModElements instance) {
		super(instance, 1152);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Patiencedog10lifeRenderer.ModelRegisterHandler());
	...
	public static class CustomEntity extends MonsterEntity {
		...
		public void onDeath(DamageSource source) {
			...
			Patiencedog10lifeEntityDiesProcedure.executeProcedure(Stream
