...
import net.useless.dogblockmod.entity.renderer.Disableddog11Renderer;
...
public class Disableddog11Entity extends DogblockmodModElements.ModElement {
	public static EntityType entity = (EntityType.Builder.<CustomEntity>create(CustomEntity::new, EntityClassification.MONSTER)
			...
			.size(0.5f, 1f)).build("disableddog_11").setRegistryName("disableddog_11");

	public Disableddog11Entity(DogblockmodModElements instance) {
		super(instance, 658);
		FMLJavaModLoadingContext.get().getModEventBus().register(new Disableddog11Renderer.ModelRegisterHandler());
	...
	public void initElements() {
		...
		elements.items
				.add(() -> new SpawnEggItem(entity, -1, -1, new Item.Properties().group(ItemGroup.MISC)).setRegistryName("disableddog_11_spawn_egg"));
	}
	...
	public static class CustomEntity extends TameableEntity {
		...
		public CustomEntity(EntityType<CustomEntity> type, World world) {
			...
			experienceValue = 10;
			setNoAI(false);
			setCustomName(new StringTextComponent("§ddisabled dog 11"));
