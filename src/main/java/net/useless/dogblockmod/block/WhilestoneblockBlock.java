...
import net.useless.dogblockmod.item.Whitestone2Item;
...
public class WhilestoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whilestoneblock")
	public static final Block block = null;

	public WhilestoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1240);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whilestoneblock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Whitestone2Item.block));
		}
	}
}
