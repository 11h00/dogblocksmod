...
import net.useless.dogblockmod.procedures.Resistdog4reverseBlockDestroyedByPlayerProcedure;
...
public class Resistdog4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_4")
	public static final Block block = null;

	public Resistdog4Block(DogblockmodModElements instance) {
		super(instance, 740);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(5f, 41f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("resistdog_4");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Resistdog4reverseBlockDestroyedByPlayerProcedure.executeProcedure(Stream
