...
public class Exdog1reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_1reverse")
	public static final Block block = null;

	public Exdog1reverseBlock(DogblockmodModElements instance) {
		super(instance, 844);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("exdog_1reverse");
		}
