...
import net.useless.dogblockmod.procedures.Verybigdog9animationProcedure;
import net.useless.dogblockmod.procedures.Verybigdog9EntityCollidesInTheBlockProcedure;
...
public class Verybigdog9Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:verybigdog_9")
	public static final Block block = null;

	public Verybigdog9Block(DogblockmodModElements instance) {
		super(instance, 66);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(95f, 95f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("verybigdog_9");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.PORKCHOP, (int) (20)));
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			Verybigdog9EntityCollidesInTheBlockProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
