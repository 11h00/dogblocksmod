...
public class DarkwoodStairsBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:darkwood_stairs")
	public static final Block block = null;

	public DarkwoodStairsBlock(DogblockmodModElements instance) {
		super(instance, 140);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("darkwood_stairs");
		}
