...
public class Dog31livesBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_31lives")
	public static final Block block = null;

	public Dog31livesBlock(DogblockmodModElements instance) {
		super(instance, 488);
	}
