...
public class Dog72Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_72")
	public static final Block block = null;

	public Dog72Block(DogblockmodModElements instance) {
		super(instance, 579);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_72_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_72"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_72"), configuredFeature);
		}
	}
