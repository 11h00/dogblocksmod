...
public class WaterblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:waterblock")
	public static final Block block = null;

	public WaterblockBlock(DogblockmodModElements instance) {
		super(instance, 1347);
	}
