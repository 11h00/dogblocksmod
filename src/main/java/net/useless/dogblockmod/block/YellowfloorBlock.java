...
public class YellowfloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:yellowfloor")
	public static final Block block = null;

	public YellowfloorBlock(DogblockmodModElements instance) {
		super(instance, 1492);
	}
