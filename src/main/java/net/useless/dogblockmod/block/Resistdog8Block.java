...
import net.useless.dogblockmod.procedures.Resistdog8BlockDestroyedByPlayerProcedure;
...
public class Resistdog8Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_8")
	public static final Block block = null;

	public Resistdog8Block(DogblockmodModElements instance) {
		super(instance, 931);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(3.5f, 35f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("resistdog_8");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Resistdog8BlockDestroyedByPlayerProcedure.executeProcedure(Stream
