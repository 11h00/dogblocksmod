...
public class Ndog12Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_12")
	public static final Block block = null;

	public Ndog12Block(DogblockmodModElements instance) {
		super(instance, 547);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_12_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_12"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_12"), configuredFeature);
		}
	}
