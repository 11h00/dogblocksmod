...
public class Ndog14Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_14")
	public static final Block block = null;

	public Ndog14Block(DogblockmodModElements instance) {
		super(instance, 533);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_14_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_14"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_14"), configuredFeature);
		}
	}
