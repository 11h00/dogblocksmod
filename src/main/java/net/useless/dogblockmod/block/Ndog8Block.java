...
public class Ndog8Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_8")
	public static final Block block = null;

	public Ndog8Block(DogblockmodModElements instance) {
		super(instance, 528);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_8_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_8"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_8"), configuredFeature);
		}
	}
