...
public class BugdogreverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bugdogreverse")
	public static final Block block = null;

	public BugdogreverseBlock(DogblockmodModElements instance) {
		super(instance, 718);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(100f, 35f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("bugdogreverse");
		}
