...
public class Longdog1headBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:longdog_1head")
	public static final Block block = null;

	public Longdog1headBlock(DogblockmodModElements instance) {
		super(instance, 632);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(30f, 175f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("longdog_1head");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEEF, (int) (5)));
		}
