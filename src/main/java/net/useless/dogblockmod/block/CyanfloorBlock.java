...
public class CyanfloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:cyanfloor")
	public static final Block block = null;

	public CyanfloorBlock(DogblockmodModElements instance) {
		super(instance, 1360);
	}
