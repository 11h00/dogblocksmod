...
import net.useless.dogblockmod.procedures.Wolf2animationProcedure;
...
public class Wolfblock2lifeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:wolfblock_2life")
	public static final Block block = null;

	public Wolfblock2lifeBlock(DogblockmodModElements instance) {
		super(instance, 1176);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("wolfblock_2life");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Wolf2animationProcedure.executeProcedure(Stream
