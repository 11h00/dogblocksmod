...
public class Unknown13Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_13")
	public static final Block block = null;

	public Unknown13Block(DogblockmodModElements instance) {
		super(instance, 1273);
	}
