...
public class BluewallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluewall")
	public static final Block block = null;

	public BluewallBlock(DogblockmodModElements instance) {
		super(instance, 990);
	}
