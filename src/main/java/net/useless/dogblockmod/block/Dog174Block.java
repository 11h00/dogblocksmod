...
public class Dog174Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_174")
	public static final Block block = null;

	public Dog174Block(DogblockmodModElements instance) {
		super(instance, 1458);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_174_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_174"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_174"), configuredFeature);
		}
	}
