...
public class DarkwoodWoodBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:darkwood_wood")
	public static final Block block = null;

	public DarkwoodWoodBlock(DogblockmodModElements instance) {
		super(instance, 136);
	}
