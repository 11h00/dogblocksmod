...
public class Unknown8Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_8")
	public static final Block block = null;

	public Unknown8Block(DogblockmodModElements instance) {
		super(instance, 1268);
	}
