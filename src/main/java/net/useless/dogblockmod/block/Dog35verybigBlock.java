...
public class Dog35verybigBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_35verybig")
	public static final Block block = null;

	public Dog35verybigBlock(DogblockmodModElements instance) {
		super(instance, 291);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(600f, 45f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("dog_35verybig");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.COOKED_CHICKEN, (int) (50)));
		}
