...
public class DogwoodsLogBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dogwoods_log")
	public static final Block block = null;

	public DogwoodsLogBlock(DogblockmodModElements instance) {
		super(instance, 502);
	}
