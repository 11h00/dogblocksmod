...
public class CyanholeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:cyanhole")
	public static final Block block = null;

	public CyanholeBlock(DogblockmodModElements instance) {
		super(instance, 1364);
	}
