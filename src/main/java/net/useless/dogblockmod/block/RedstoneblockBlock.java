...
public class RedstoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:redstoneblock")
	public static final Block block = null;

	public RedstoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1225);
	}
