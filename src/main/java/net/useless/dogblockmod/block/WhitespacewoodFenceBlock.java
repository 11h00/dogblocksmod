...
public class WhitespacewoodFenceBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_fence")
	public static final Block block = null;

	public WhitespacewoodFenceBlock(DogblockmodModElements instance) {
		super(instance, 188);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_fence");
		}
