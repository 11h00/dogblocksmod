...
public class ReverseFinaldogpart9Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_9")
	public static final Block block = null;

	public ReverseFinaldogpart9Block(DogblockmodModElements instance) {
		super(instance, 956);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_9");
		}
