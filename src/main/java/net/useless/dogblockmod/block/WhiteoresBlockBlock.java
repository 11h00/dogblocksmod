...
public class WhiteoresBlockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whiteores_block")
	public static final Block block = null;

	public WhiteoresBlockBlock(DogblockmodModElements instance) {
		super(instance, 214);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whiteores_block");
		}
