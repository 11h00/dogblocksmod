...
public class Unknown6Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_6")
	public static final Block block = null;

	public Unknown6Block(DogblockmodModElements instance) {
		super(instance, 1266);
	}
