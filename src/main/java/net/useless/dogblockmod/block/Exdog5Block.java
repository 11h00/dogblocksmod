...
import net.useless.dogblockmod.procedures.Exdog5BlockDestroyedByPlayerProcedure;
...
public class Exdog5Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_5")
	public static final Block block = null;

	public Exdog5Block(DogblockmodModElements instance) {
		super(instance, 849);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Exdog5BlockDestroyedByPlayerProcedure.executeProcedure(Stream
