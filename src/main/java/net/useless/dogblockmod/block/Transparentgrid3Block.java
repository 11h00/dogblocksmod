...
public class Transparentgrid3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:transparentgrid_3")
	public static final Block block = null;

	public Transparentgrid3Block(DogblockmodModElements instance) {
		super(instance, 1479);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("transparentgrid_3");
		}
