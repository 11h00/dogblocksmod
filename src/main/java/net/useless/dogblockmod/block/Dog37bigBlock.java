...
public class Dog37bigBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_37big")
	public static final Block block = null;

	public Dog37bigBlock(DogblockmodModElements instance) {
		super(instance, 299);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.GOLDEN_CARROT, (int) (8)));
		}
