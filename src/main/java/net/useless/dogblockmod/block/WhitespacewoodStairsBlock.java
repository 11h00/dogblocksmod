...
public class WhitespacewoodStairsBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_stairs")
	public static final Block block = null;

	public WhitespacewoodStairsBlock(DogblockmodModElements instance) {
		super(instance, 186);
	}
	...
	public static class CustomBlock extends StairsBlock {
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_stairs");
		}
