...
public class BrownwallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:brownwall")
	public static final Block block = null;

	public BrownwallBlock(DogblockmodModElements instance) {
		super(instance, 916);
	}
