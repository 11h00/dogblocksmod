...
public class PinkfloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:pinkfloor")
	public static final Block block = null;

	public PinkfloorBlock(DogblockmodModElements instance) {
		super(instance, 1358);
	}
