...
public class Ndog28Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_28")
	public static final Block block = null;

	public Ndog28Block(DogblockmodModElements instance) {
		super(instance, 541);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_28_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_28"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_28"), configuredFeature);
		}
	}
