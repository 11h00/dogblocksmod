...
public class Verybiglongdog1headBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:verybiglongdog_1head")
	public static final Block block = null;

	public Verybiglongdog1headBlock(DogblockmodModElements instance) {
		super(instance, 638);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(200f, 175f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("verybiglongdog_1head");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEEF, (int) (19)));
		}
