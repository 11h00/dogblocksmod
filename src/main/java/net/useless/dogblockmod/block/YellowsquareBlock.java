...
public class YellowsquareBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:yellowsquare")
	public static final Block block = null;

	public YellowsquareBlock(DogblockmodModElements instance) {
		super(instance, 1494);
	}
