...
import net.useless.dogblockmod.procedures.Exdog4OnBlockRightClickedProcedure;
import net.useless.dogblockmod.procedures.Exdog4BlockDestroyedByPlayerProcedure;
...
public class Exdog4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_4")
	public static final Block block = null;

	public Exdog4Block(DogblockmodModElements instance) {
		super(instance, 839);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(3.5f, 35f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("exdog_4");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Exdog4BlockDestroyedByPlayerProcedure.executeProcedure(Stream
		...
		public ActionResultType onBlockActivated(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Exdog4OnBlockRightClickedProcedure.executeProcedure(Stream
					.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x), new AbstractMap.SimpleEntry<>("y", y),
							new AbstractMap.SimpleEntry<>("z", z))
					.collect(HashMap::new, (_m, _e) -> _m.put(_e.getKey(), _e.getValue()), Map::putAll));
