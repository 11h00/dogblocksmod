...
public class Dog124Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_124")
	public static final Block block = null;

	public Dog124Block(DogblockmodModElements instance) {
		super(instance, 696);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_124_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_124"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_124"), configuredFeature);
		}
	}
