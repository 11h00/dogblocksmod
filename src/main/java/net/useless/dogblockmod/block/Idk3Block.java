...
import net.useless.dogblockmod.procedures.Fidk3bProcedure;
...
public class Idk3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:idk_3")
	public static final Block block = null;

	public Idk3Block(DogblockmodModElements instance) {
		super(instance, 1424);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Fidk3bProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:idk_3_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("idk_3"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:idk_3"), configuredFeature);
		}
	}
