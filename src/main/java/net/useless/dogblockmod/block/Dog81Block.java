...
public class Dog81Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_81")
	public static final Block block = null;

	public Dog81Block(DogblockmodModElements instance) {
		super(instance, 600);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.GOLD_INGOT, (int) (2)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_81_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_81"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_81"), configuredFeature);
		}
	}
