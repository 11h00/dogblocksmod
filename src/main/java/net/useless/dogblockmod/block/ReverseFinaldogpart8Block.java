...
public class ReverseFinaldogpart8Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_8")
	public static final Block block = null;

	public ReverseFinaldogpart8Block(DogblockmodModElements instance) {
		super(instance, 955);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_8");
		}
