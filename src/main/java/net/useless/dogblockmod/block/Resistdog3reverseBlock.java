...
public class Resistdog3reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_3reverse")
	public static final Block block = null;

	public Resistdog3reverseBlock(DogblockmodModElements instance) {
		super(instance, 741);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("resistdog_3reverse");
		}
