...
public class WhitespacewoodPlanksBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_planks")
	public static final Block block = null;

	public WhitespacewoodPlanksBlock(DogblockmodModElements instance) {
		super(instance, 184);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_planks");
		}
