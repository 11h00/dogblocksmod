...
import net.useless.dogblockmod.procedures.Exdog2BlockDestroyedByPlayerProcedure;
...
public class Exdog2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_2")
	public static final Block block = null;

	public Exdog2Block(DogblockmodModElements instance) {
		super(instance, 845);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Exdog2BlockDestroyedByPlayerProcedure.executeProcedure(Stream
