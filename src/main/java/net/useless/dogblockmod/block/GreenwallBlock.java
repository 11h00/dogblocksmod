...
public class GreenwallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:greenwall")
	public static final Block block = null;

	public GreenwallBlock(DogblockmodModElements instance) {
		super(instance, 1356);
	}
