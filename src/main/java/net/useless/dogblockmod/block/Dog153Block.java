...
public class Dog153Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_153")
	public static final Block block = null;

	public Dog153Block(DogblockmodModElements instance) {
		super(instance, 872);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_153_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_153"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_153"), configuredFeature);
		}
	}
