...
import net.useless.dogblockmod.procedures.Bossblock1life9BlockDestroyedByPlayerProcedure;
...
public class Bossblock1life9Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bossblock_1life_9")
	public static final Block block = null;

	public Bossblock1life9Block(DogblockmodModElements instance) {
		super(instance, 762);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("bossblock_1life_9");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Bossblock1life9BlockDestroyedByPlayerProcedure.executeProcedure(Stream
