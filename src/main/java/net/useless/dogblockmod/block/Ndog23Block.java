...
public class Ndog23Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_23")
	public static final Block block = null;

	public Ndog23Block(DogblockmodModElements instance) {
		super(instance, 537);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_23_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_23"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_23"), configuredFeature);
		}
	}
