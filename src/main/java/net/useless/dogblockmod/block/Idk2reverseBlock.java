...
public class Idk2reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:idk_2reverse")
	public static final Block block = null;

	public Idk2reverseBlock(DogblockmodModElements instance) {
		super(instance, 1422);
	}
