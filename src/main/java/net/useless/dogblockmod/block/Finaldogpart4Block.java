...
public class Finaldogpart4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_4")
	public static final Block block = null;

	public Finaldogpart4Block(DogblockmodModElements instance) {
		super(instance, 942);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_4");
		}
