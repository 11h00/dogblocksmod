...
public class BluewallunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluewallunbreakable")
	public static final Block block = null;

	public BluewallunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 988);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluewallunbreakable");
		}
