...
public class Verybigdog10reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:verybigdog_10reverse")
	public static final Block block = null;

	public Verybigdog10reverseBlock(DogblockmodModElements instance) {
		super(instance, 93);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(5000f, 150f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("verybigdog_10reverse");
		}
