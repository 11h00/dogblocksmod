...
public class BrownfloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:brownfloor")
	public static final Block block = null;

	public BrownfloorBlock(DogblockmodModElements instance) {
		super(instance, 914);
	}
