...
public class YellowstoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:yellowstoneblock")
	public static final Block block = null;

	public YellowstoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1235);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellowstoneblock");
		}
