...
public class DogwoodsButtonBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dogwoods_button")
	public static final Block block = null;

	public DogwoodsButtonBlock(DogblockmodModElements instance) {
		super(instance, 510);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("dogwoods_button");
		}
