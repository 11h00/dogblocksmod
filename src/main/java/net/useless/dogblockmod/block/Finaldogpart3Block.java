...
public class Finaldogpart3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_3")
	public static final Block block = null;

	public Finaldogpart3Block(DogblockmodModElements instance) {
		super(instance, 941);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_3");
		}
