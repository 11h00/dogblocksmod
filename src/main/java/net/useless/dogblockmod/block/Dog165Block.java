...
public class Dog165Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_165")
	public static final Block block = null;

	public Dog165Block(DogblockmodModElements instance) {
		super(instance, 1449);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_165_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_165"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_165"), configuredFeature);
		}
	}
