...
import net.useless.dogblockmod.procedures.Finaldogpart2BlockAddedProcedure;
import net.useless.dogblockmod.procedures.FinaldogdestroyProcedure;
...
public class Finaldogpart2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_2")
	public static final Block block = null;

	public Finaldogpart2Block(DogblockmodModElements instance) {
		super(instance, 940);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_2");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			Finaldogpart2BlockAddedProcedure.executeProcedure(Stream
		...
		public void neighborChanged(BlockState blockstate, World world, BlockPos pos, Block neighborBlock, BlockPos fromPos, boolean moving) {
			...
			if (world.getRedstonePowerFromNeighbors(new BlockPos(x, y, z)) > 0) {
				...
				FinaldogdestroyProcedure.executeProcedure(Stream
