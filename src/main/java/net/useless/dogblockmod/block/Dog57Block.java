...
public class Dog57Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_57")
	public static final Block block = null;

	public Dog57Block(DogblockmodModElements instance) {
		super(instance, 556);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_57_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_57"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_57"), configuredFeature);
		}
	}
