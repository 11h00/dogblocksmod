...
public class ReverseFinaldogpart5Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_5")
	public static final Block block = null;

	public ReverseFinaldogpart5Block(DogblockmodModElements instance) {
		super(instance, 952);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_5");
		}
