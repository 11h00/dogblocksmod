...
public class PurplefloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:purplefloor")
	public static final Block block = null;

	public PurplefloorBlock(DogblockmodModElements instance) {
		super(instance, 1220);
	}
