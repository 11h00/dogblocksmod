...
public class CyanblueballBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:cyanblueball")
	public static final Block block = null;

	public CyanblueballBlock(DogblockmodModElements instance) {
		super(instance, 1363);
	}
