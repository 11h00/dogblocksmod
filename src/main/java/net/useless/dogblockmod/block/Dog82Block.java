...
public class Dog82Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_82")
	public static final Block block = null;

	public Dog82Block(DogblockmodModElements instance) {
		super(instance, 613);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_82_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_82"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_82"), configuredFeature);
		}
	}
