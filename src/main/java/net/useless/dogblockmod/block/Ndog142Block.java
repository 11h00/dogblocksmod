...
public class Ndog142Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_142")
	public static final Block block = null;

	public Ndog142Block(DogblockmodModElements instance) {
		super(instance, 835);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_142_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_142"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_142"), configuredFeature);
		}
	}
