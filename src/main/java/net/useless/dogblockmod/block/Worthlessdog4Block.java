...
public class Worthlessdog4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:worthlessdog_4")
	public static final Block block = null;

	public Worthlessdog4Block(DogblockmodModElements instance) {
		super(instance, 924);
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(15f, 15f).setLightLevel(s -> 0).harvestLevel(0).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("worthlessdog_4");
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:worthlessdog_4_match"),
			...
			event.getRegistry().register(feature.setRegistryName("worthlessdog_4"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:worthlessdog_4"), configuredFeature);
		}
	}
