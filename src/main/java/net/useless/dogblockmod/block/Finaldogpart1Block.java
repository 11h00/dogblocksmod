...
public class Finaldogpart1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_1")
	public static final Block block = null;

	public Finaldogpart1Block(DogblockmodModElements instance) {
		super(instance, 939);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_1");
		}
