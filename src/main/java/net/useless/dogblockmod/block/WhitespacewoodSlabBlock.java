...
public class WhitespacewoodSlabBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_slab")
	public static final Block block = null;

	public WhitespacewoodSlabBlock(DogblockmodModElements instance) {
		super(instance, 187);
	}
	...
	public static class CustomBlock extends SlabBlock {
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_slab");
		}
