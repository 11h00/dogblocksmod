...
public class BrownwallunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:brownwallunbreakable")
	public static final Block block = null;

	public BrownwallunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 917);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brownwallunbreakable");
		}
