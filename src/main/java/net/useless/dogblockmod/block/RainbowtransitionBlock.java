...
public class RainbowtransitionBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:rainbowtransition")
	public static final Block block = null;

	public RainbowtransitionBlock(DogblockmodModElements instance) {
		super(instance, 967);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rainbowtransition");
		}
