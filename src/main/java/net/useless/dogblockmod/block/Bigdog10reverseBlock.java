...
public class Bigdog10reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bigdog_10reverse")
	public static final Block block = null;

	public Bigdog10reverseBlock(DogblockmodModElements instance) {
		super(instance, 89);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(2500f, 45f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("bigdog_10reverse");
		}
