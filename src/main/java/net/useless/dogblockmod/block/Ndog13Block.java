...
public class Ndog13Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_13")
	public static final Block block = null;

	public Ndog13Block(DogblockmodModElements instance) {
		super(instance, 548);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_13_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_13"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_13"), configuredFeature);
		}
	}
