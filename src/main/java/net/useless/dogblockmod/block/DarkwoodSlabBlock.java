...
public class DarkwoodSlabBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:darkwood_slab")
	public static final Block block = null;

	public DarkwoodSlabBlock(DogblockmodModElements instance) {
		super(instance, 141);
	}
