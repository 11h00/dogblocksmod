...
public class Dog131Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_131")
	public static final Block block = null;

	public Dog131Block(DogblockmodModElements instance) {
		super(instance, 703);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_131_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_131"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_131"), configuredFeature);
		}
	}
