...
public class CloudskyblockredBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:cloudskyblockred")
	public static final Block block = null;

	public CloudskyblockredBlock(DogblockmodModElements instance) {
		super(instance, 1635);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("cloudskyblockred");
		}
