...
public class Ndog29Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_29")
	public static final Block block = null;

	public Ndog29Block(DogblockmodModElements instance) {
		super(instance, 542);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_29_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_29"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_29"), configuredFeature);
		}
	}
