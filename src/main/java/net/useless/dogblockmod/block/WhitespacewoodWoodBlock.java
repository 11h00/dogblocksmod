...
public class WhitespacewoodWoodBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_wood")
	public static final Block block = null;

	public WhitespacewoodWoodBlock(DogblockmodModElements instance) {
		super(instance, 182);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_wood");
		}
