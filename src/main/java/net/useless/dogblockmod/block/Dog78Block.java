...
public class Dog78Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_78")
	public static final Block block = null;

	public Dog78Block(DogblockmodModElements instance) {
		super(instance, 594);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_78_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_78"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_78"), configuredFeature);
		}
	}
