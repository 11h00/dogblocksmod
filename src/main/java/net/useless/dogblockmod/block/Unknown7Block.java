...
public class Unknown7Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_7")
	public static final Block block = null;

	public Unknown7Block(DogblockmodModElements instance) {
		super(instance, 1267);
	}
