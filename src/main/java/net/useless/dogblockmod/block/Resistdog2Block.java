...
import net.useless.dogblockmod.procedures.Resistdog2BlockDestroyedByPlayerProcedure;
...
public class Resistdog2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_2")
	public static final Block block = null;

	public Resistdog2Block(DogblockmodModElements instance) {
		super(instance, 724);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(5f, 35f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool());
			setRegistryName("resistdog_2");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Resistdog2BlockDestroyedByPlayerProcedure.executeProcedure(Stream
