...
import net.useless.dogblockmod.procedures.LongdogbodyQuandLeBlocEstAjouteProcedure;
...
public class LongdogbodyBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:longdogbody")
	public static final Block block = null;

	public LongdogbodyBlock(DogblockmodModElements instance) {
		super(instance, 633);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(85f, 175f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("longdogbody");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEEF, (int) (9)));
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			LongdogbodyQuandLeBlocEstAjouteProcedure.executeProcedure(Stream
