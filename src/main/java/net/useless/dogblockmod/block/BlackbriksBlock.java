...
public class BlackbriksBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:blackbriks")
	public static final Block block = null;

	public BlackbriksBlock(DogblockmodModElements instance) {
		super(instance, 116);
	}
