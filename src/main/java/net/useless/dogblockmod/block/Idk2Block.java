...
import net.useless.dogblockmod.procedures.Fidk2bProcedure;
...
public class Idk2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:idk_2")
	public static final Block block = null;

	public Idk2Block(DogblockmodModElements instance) {
		super(instance, 1421);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Fidk2bProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:idk_2_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("idk_2"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:idk_2"), configuredFeature);
		}
	}
