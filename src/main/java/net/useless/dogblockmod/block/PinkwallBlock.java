...
public class PinkwallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:pinkwall")
	public static final Block block = null;

	public PinkwallBlock(DogblockmodModElements instance) {
		super(instance, 1359);
	}
