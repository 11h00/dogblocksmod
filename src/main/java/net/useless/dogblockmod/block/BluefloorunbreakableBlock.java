...
public class BluefloorunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluefloorunbreakable")
	public static final Block block = null;

	public BluefloorunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 989);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("bluefloorunbreakable");
		}
