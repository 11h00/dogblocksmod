...
public class Exdog2reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_2reverse")
	public static final Block block = null;

	public Exdog2reverseBlock(DogblockmodModElements instance) {
		super(instance, 846);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("exdog_2reverse");
		}
