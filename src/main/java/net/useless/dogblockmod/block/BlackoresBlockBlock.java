...
public class BlackoresBlockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:blackores_block")
	public static final Block block = null;

	public BlackoresBlockBlock(DogblockmodModElements instance) {
		super(instance, 132);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blackores_block");
		}
