...
public class Unknown3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_3")
	public static final Block block = null;

	public Unknown3Block(DogblockmodModElements instance) {
		super(instance, 1263);
	}
