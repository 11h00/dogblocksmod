...
public class Resistdog5bigreverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_5bigreverse")
	public static final Block block = null;

	public Resistdog5bigreverseBlock(DogblockmodModElements instance) {
		super(instance, 805);
	}
