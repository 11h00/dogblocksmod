...
public class Dog90Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_90")
	public static final Block block = null;

	public Dog90Block(DogblockmodModElements instance) {
		super(instance, 660);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_90_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_90"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_90"), configuredFeature);
		}
	}
