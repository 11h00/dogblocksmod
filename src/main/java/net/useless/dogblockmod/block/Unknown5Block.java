...
public class Unknown5Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_5")
	public static final Block block = null;

	public Unknown5Block(DogblockmodModElements instance) {
		super(instance, 1265);
	}
