...
public class Dog85lives1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_85lives_1")
	public static final Block block = null;

	public Dog85lives1Block(DogblockmodModElements instance) {
		super(instance, 623);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.LEATHER));
		}
