...
public class StarlyskyBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:starlysky")
	public static final Block block = null;

	public StarlyskyBlock(DogblockmodModElements instance) {
		super(instance, 959);
	}
