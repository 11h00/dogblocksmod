...
public class Bigdog4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bigdog_4")
	public static final Block block = null;

	public Bigdog4Block(DogblockmodModElements instance) {
		super(instance, 922);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(120f, 75f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("bigdog_4");
		}
