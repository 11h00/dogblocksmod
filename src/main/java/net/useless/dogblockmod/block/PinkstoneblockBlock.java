...
import net.useless.dogblockmod.item.PinkstoneItem;
...
public class PinkstoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:pinkstoneblock")
	public static final Block block = null;

	public PinkstoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1239);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("pinkstoneblock");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(PinkstoneItem.block));
		}
	}
}
