...
public class DarkwoodFenceBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:darkwood_fence")
	public static final Block block = null;

	public DarkwoodFenceBlock(DogblockmodModElements instance) {
		super(instance, 142);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("darkwood_fence");
		}
