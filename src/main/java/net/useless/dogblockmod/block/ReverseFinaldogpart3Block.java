...
public class ReverseFinaldogpart3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_3")
	public static final Block block = null;

	public ReverseFinaldogpart3Block(DogblockmodModElements instance) {
		super(instance, 950);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_3");
		}
