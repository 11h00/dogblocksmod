...
public class Dog39bigBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_39big")
	public static final Block block = null;

	public Dog39bigBlock(DogblockmodModElements instance) {
		super(instance, 303);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(500f, 300f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dog_39big");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.EXPERIENCE_BOTTLE, (int) (26)));
		}
