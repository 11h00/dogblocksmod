...
public class Dog136Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_136")
	public static final Block block = null;

	public Dog136Block(DogblockmodModElements instance) {
		super(instance, 828);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_136_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_136"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_136"), configuredFeature);
		}
	}
