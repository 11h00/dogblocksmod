...
public class Dog125Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_125")
	public static final Block block = null;

	public Dog125Block(DogblockmodModElements instance) {
		super(instance, 697);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_125_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_125"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_125"), configuredFeature);
		}
	}
