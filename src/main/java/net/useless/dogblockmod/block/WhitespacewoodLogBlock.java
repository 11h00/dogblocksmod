...
public class WhitespacewoodLogBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_log")
	public static final Block block = null;

	public WhitespacewoodLogBlock(DogblockmodModElements instance) {
		super(instance, 183);
	}
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_log");
		}
