...
public class Dog106Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_106")
	public static final Block block = null;

	public Dog106Block(DogblockmodModElements instance) {
		super(instance, 679);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_106_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_106"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_106"), configuredFeature);
		}
	}
