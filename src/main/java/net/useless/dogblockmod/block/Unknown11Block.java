...
public class Unknown11Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_11")
	public static final Block block = null;

	public Unknown11Block(DogblockmodModElements instance) {
		super(instance, 1271);
	}
