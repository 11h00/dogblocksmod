...
public class DasuriteBlockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dasurite_block")
	public static final Block block = null;

	public DasuriteBlockBlock(DogblockmodModElements instance) {
		super(instance, 1520);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("dasurite_block");
		}
