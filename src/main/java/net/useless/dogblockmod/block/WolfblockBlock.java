...
import net.useless.dogblockmod.procedures.Wolf0animationProcedure;
...
public class WolfblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:wolfblock")
	public static final Block block = null;

	public WolfblockBlock(DogblockmodModElements instance) {
		super(instance, 1178);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Wolf0animationProcedure.executeProcedure(Stream
