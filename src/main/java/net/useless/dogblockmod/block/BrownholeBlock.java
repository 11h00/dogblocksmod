...
public class BrownholeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:brownhole")
	public static final Block block = null;

	public BrownholeBlock(DogblockmodModElements instance) {
		super(instance, 920);
	}
