...
public class YellowwallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:yellowwall")
	public static final Block block = null;

	public YellowwallBlock(DogblockmodModElements instance) {
		super(instance, 1493);
	}
