...
public class RanboxlinesBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ranboxlines")
	public static final Block block = null;

	public RanboxlinesBlock(DogblockmodModElements instance) {
		super(instance, 918);
	}
