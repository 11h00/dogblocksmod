...
public class Dog156Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_156")
	public static final Block block = null;

	public Dog156Block(DogblockmodModElements instance) {
		super(instance, 1211);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_156_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_156"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_156"), configuredFeature);
		}
	}
