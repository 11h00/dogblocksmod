...
public class ReverseFinaldogpart6Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_6")
	public static final Block block = null;

	public ReverseFinaldogpart6Block(DogblockmodModElements instance) {
		super(instance, 953);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_6");
		}
