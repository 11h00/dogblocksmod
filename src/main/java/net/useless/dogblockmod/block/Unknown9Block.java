...
public class Unknown9Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_9")
	public static final Block block = null;

	public Unknown9Block(DogblockmodModElements instance) {
		super(instance, 1269);
	}
