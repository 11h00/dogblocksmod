...
public class Dog118Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_118")
	public static final Block block = null;

	public Dog118Block(DogblockmodModElements instance) {
		super(instance, 691);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_118_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_118"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_118"), configuredFeature);
		}
	}
