...
public class Ndog5Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_5")
	public static final Block block = null;

	public Ndog5Block(DogblockmodModElements instance) {
		super(instance, 526);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_5_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_5"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_5"), configuredFeature);
		}
	}
