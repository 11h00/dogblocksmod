...
public class Resistdog5reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_5reverse")
	public static final Block block = null;

	public Resistdog5reverseBlock(DogblockmodModElements instance) {
		super(instance, 803);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("resistdog_5reverse");
		}
