...
import net.useless.dogblockmod.procedures.Idk1BlockDestroyedByPlayerProcedure;
...
public class Idk1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:idk_1")
	public static final Block block = null;

	public Idk1Block(DogblockmodModElements instance) {
		super(instance, 1417);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Idk1BlockDestroyedByPlayerProcedure.executeProcedure(Stream
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:idk_1_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 3)).range(52)
					.square().func_242731_b(3);
			event.getRegistry().register(feature.setRegistryName("idk_1"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:idk_1"), configuredFeature);
		}
	}
