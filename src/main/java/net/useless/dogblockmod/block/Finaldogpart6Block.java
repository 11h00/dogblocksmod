...
public class Finaldogpart6Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_6")
	public static final Block block = null;

	public Finaldogpart6Block(DogblockmodModElements instance) {
		super(instance, 944);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_6");
		}
