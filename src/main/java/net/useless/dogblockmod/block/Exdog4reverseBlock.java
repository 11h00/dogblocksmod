...
public class Exdog4reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_4reverse")
	public static final Block block = null;

	public Exdog4reverseBlock(DogblockmodModElements instance) {
		super(instance, 840);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("exdog_4reverse");
		}
