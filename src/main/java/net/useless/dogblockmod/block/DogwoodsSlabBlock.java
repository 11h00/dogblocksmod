...
public class DogwoodsSlabBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dogwoods_slab")
	public static final Block block = null;

	public DogwoodsSlabBlock(DogblockmodModElements instance) {
		super(instance, 506);
	}
