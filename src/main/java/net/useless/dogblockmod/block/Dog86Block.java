...
public class Dog86Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_86")
	public static final Block block = null;

	public Dog86Block(DogblockmodModElements instance) {
		super(instance, 616);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_86_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_86"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_86"), configuredFeature);
		}
	}
