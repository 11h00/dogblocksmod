...
import net.useless.dogblockmod.procedures.Exdog3BlockDestroyedByPlayerProcedure;
...
public class Exdog3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_3")
	public static final Block block = null;

	public Exdog3Block(DogblockmodModElements instance) {
		super(instance, 847);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Exdog3BlockDestroyedByPlayerProcedure.executeProcedure(Stream
