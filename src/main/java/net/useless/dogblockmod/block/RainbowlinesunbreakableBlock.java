...
public class RainbowlinesunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:rainbowlinesunbreakable")
	public static final Block block = null;

	public RainbowlinesunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 919);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("rainbowlinesunbreakable");
		}
