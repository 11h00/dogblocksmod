...
public class YellowfishplaceholderBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:yellowfishplaceholder")
	public static final Block block = null;

	public YellowfishplaceholderBlock(DogblockmodModElements instance) {
		super(instance, 1496);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("yellowfishplaceholder");
		}
