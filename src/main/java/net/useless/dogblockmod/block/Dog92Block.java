...
public class Dog92Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_92")
	public static final Block block = null;

	public Dog92Block(DogblockmodModElements instance) {
		super(instance, 662);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.COOKED_BEEF, (int) (7)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_92_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_92"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_92"), configuredFeature);
		}
	}
