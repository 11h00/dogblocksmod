...
import net.useless.dogblockmod.item.WhiteoresItem;
...
public class Dog33Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_33")
	public static final Block block = null;

	public Dog33Block(DogblockmodModElements instance) {
		super(instance, 260);
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(35f, 55f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("dog_33");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(WhiteoresItem.block));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_33_match"), () -> CustomRuleTest.codec);
			...
			configuredFeature = feature.withConfiguration(new OreFeatureConfig(CustomRuleTest.INSTANCE, block.getDefaultState(), 4)).range(59)
					.square().func_242731_b(4);
			event.getRegistry().register(feature.setRegistryName("dog_33"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_33"), configuredFeature);
		}
	}
