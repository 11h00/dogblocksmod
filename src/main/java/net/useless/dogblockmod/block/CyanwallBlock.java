...
public class CyanwallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:cyanwall")
	public static final Block block = null;

	public CyanwallBlock(DogblockmodModElements instance) {
		super(instance, 1361);
	}
