...
public class BlackplantBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:blackplant")
	public static final Block block = null;

	public BlackplantBlock(DogblockmodModElements instance) {
		super(instance, 226);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("blackplant"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:blackplant"), configuredFeature);
		}
	}
