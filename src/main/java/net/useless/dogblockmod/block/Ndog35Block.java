...
public class Ndog35Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_35")
	public static final Block block = null;

	public Ndog35Block(DogblockmodModElements instance) {
		super(instance, 549);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.COOKED_CHICKEN, (int) (11)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_35_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_35"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_35"), configuredFeature);
		}
	}
