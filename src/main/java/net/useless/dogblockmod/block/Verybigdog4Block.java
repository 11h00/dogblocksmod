...
public class Verybigdog4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:verybigdog_4")
	public static final Block block = null;

	public Verybigdog4Block(DogblockmodModElements instance) {
		super(instance, 923);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(300f, 95f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("verybigdog_4");
		}
