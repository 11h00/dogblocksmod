...
public class Unknown4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_4")
	public static final Block block = null;

	public Unknown4Block(DogblockmodModElements instance) {
		super(instance, 1264);
	}
