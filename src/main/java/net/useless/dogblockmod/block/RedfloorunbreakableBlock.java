...
public class RedfloorunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:redfloorunbreakable")
	public static final Block block = null;

	public RedfloorunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 993);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("redfloorunbreakable");
		}
