...
public class Finaldogpart7Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_7")
	public static final Block block = null;

	public Finaldogpart7Block(DogblockmodModElements instance) {
		super(instance, 945);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_7");
		}
