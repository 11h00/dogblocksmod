...
public class Bigdog9reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bigdog_9reverse")
	public static final Block block = null;

	public Bigdog9reverseBlock(DogblockmodModElements instance) {
		super(instance, 74);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(105f, 75f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("bigdog_9reverse");
		}
