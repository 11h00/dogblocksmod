...
public class YellowholeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:yellowhole")
	public static final Block block = null;

	public YellowholeBlock(DogblockmodModElements instance) {
		super(instance, 1495);
	}
