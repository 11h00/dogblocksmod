...
public class Bluewall1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluewall_1")
	public static final Block block = null;

	public Bluewall1Block(DogblockmodModElements instance) {
		super(instance, 1244);
	}
