...
public class Ndog34Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_34")
	public static final Block block = null;

	public Ndog34Block(DogblockmodModElements instance) {
		super(instance, 545);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_34_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_34"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_34"), configuredFeature);
		}
	}
