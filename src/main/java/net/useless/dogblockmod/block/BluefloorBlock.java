...
public class BluefloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluefloor")
	public static final Block block = null;

	public BluefloorBlock(DogblockmodModElements instance) {
		super(instance, 991);
	}
