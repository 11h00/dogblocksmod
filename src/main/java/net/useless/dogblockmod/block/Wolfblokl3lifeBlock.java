...
import net.useless.dogblockmod.procedures.Wolf3animationProcedure;
...
public class Wolfblokl3lifeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:wolfblokl_3life")
	public static final Block block = null;

	public Wolfblokl3lifeBlock(DogblockmodModElements instance) {
		super(instance, 1175);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("wolfblokl_3life");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Wolf3animationProcedure.executeProcedure(Stream
