...
public class CyanredballBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:cyanredball")
	public static final Block block = null;

	public CyanredballBlock(DogblockmodModElements instance) {
		super(instance, 1362);
	}
