...
public class Dog129Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_129")
	public static final Block block = null;

	public Dog129Block(DogblockmodModElements instance) {
		super(instance, 701);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_129_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_129"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_129"), configuredFeature);
		}
	}
