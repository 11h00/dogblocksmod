...
import net.useless.dogblockmod.item.BluestoneItem;
...
public class BluestoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluestoneblock")
	public static final Block block = null;

	public BluestoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1232);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(BluestoneItem.block));
		}
	}
}
