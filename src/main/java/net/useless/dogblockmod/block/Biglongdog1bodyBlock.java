...
import net.useless.dogblockmod.procedures.Biglongdog1bodyQuandLeBlocEstAjouteProcedure;
...
public class Biglongdog1bodyBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:biglongdog_1body")
	public static final Block block = null;

	public Biglongdog1bodyBlock(DogblockmodModElements instance) {
		super(instance, 636);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(160f, 175f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("biglongdog_1body");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEEF, (int) (20)));
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			Biglongdog1bodyQuandLeBlocEstAjouteProcedure.executeProcedure(Stream
