...
public class Bluefloor1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bluefloor_1")
	public static final Block block = null;

	public Bluefloor1Block(DogblockmodModElements instance) {
		super(instance, 1243);
	}
