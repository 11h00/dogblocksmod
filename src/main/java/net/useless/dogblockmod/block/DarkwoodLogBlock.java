...
public class DarkwoodLogBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:darkwood_log")
	public static final Block block = null;

	public DarkwoodLogBlock(DogblockmodModElements instance) {
		super(instance, 137);
	}
