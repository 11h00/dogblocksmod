...
public class Transparantgrid2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:transparantgrid_2")
	public static final Block block = null;

	public Transparantgrid2Block(DogblockmodModElements instance) {
		super(instance, 1475);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("transparantgrid_2");
		}
