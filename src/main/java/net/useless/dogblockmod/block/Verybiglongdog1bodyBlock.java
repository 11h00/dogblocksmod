...
import net.useless.dogblockmod.procedures.Verybiglongdog1bodyQuandLeBlocEstAjouteProcedure;
...
public class Verybiglongdog1bodyBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:verybiglongdog_1body")
	public static final Block block = null;

	public Verybiglongdog1bodyBlock(DogblockmodModElements instance) {
		super(instance, 639);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(350f, 175f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("verybiglongdog_1body");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEEF, (int) (31)));
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			Verybiglongdog1bodyQuandLeBlocEstAjouteProcedure.executeProcedure(Stream
