...
public class ReverseFinaldogpart7Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_7")
	public static final Block block = null;

	public ReverseFinaldogpart7Block(DogblockmodModElements instance) {
		super(instance, 954);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_7");
		}
