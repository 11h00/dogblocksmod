...
import net.useless.dogblockmod.item.GreenstoneItem;
...
public class GreenstoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:greenstoneblock")
	public static final Block block = null;

	public GreenstoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1237);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(GreenstoneItem.block));
		}
	}
}
