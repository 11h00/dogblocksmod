...
public class GreenfloorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:greenfloor")
	public static final Block block = null;

	public GreenfloorBlock(DogblockmodModElements instance) {
		super(instance, 1355);
	}
