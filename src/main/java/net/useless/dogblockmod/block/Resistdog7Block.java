...
import net.useless.dogblockmod.procedures.Resistdog7BlockDestroyedByPlayerProcedure;
...
public class Resistdog7Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_7")
	public static final Block block = null;

	public Resistdog7Block(DogblockmodModElements instance) {
		super(instance, 929);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Resistdog7BlockDestroyedByPlayerProcedure.executeProcedure(Stream
