...
public class Verybigdog9reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:verybigdog_9reverse")
	public static final Block block = null;

	public Verybigdog9reverseBlock(DogblockmodModElements instance) {
		super(instance, 76);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(20000f, 75f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("verybigdog_9reverse");
		}
