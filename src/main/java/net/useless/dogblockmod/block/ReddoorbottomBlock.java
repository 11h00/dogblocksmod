...
import net.useless.dogblockmod.procedures.ReddoorbottomBlockAddedProcedure;
...
public class ReddoorbottomBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reddoorbottom")
	public static final Block block = null;

	public ReddoorbottomBlock(DogblockmodModElements instance) {
		super(instance, 880);
	}
	...
	public static class CustomBlock extends Block {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			ReddoorbottomBlockAddedProcedure.executeProcedure(Stream
