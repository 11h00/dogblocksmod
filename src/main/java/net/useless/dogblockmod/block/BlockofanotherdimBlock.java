...
public class BlockofanotherdimBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:blockofanotherdim")
	public static final Block block = null;

	public BlockofanotherdimBlock(DogblockmodModElements instance) {
		super(instance, 3);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("blockofanotherdim");
		}
