...
public class Resistdog6Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_6")
	public static final Block block = null;

	public Resistdog6Block(DogblockmodModElements instance) {
		super(instance, 927);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Resistdog6BlockDestroyedByPlayerProcedure.executeProcedure(Stream
