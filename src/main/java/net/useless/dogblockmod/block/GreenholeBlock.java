...
public class GreenholeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:greenhole")
	public static final Block block = null;

	public GreenholeBlock(DogblockmodModElements instance) {
		super(instance, 1357);
	}
