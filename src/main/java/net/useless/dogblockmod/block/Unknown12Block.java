...
public class Unknown12Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_12")
	public static final Block block = null;

	public Unknown12Block(DogblockmodModElements instance) {
		super(instance, 1272);
	}
