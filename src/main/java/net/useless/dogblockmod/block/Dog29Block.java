...
public class Dog29Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_29")
	public static final Block block = null;

	public Dog29Block(DogblockmodModElements instance) {
		super(instance, 255);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_29_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_29"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_29"), configuredFeature);
		}
	}
