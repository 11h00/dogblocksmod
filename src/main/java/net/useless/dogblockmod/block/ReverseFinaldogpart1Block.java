...
public class ReverseFinaldogpart1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_1")
	public static final Block block = null;

	public ReverseFinaldogpart1Block(DogblockmodModElements instance) {
		super(instance, 948);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_1");
		}
