...
public class StarlyskyunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:starlyskyunbreakable")
	public static final Block block = null;

	public StarlyskyunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 960);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("starlyskyunbreakable");
		}
