...
public class Dog116Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_116")
	public static final Block block = null;

	public Dog116Block(DogblockmodModElements instance) {
		super(instance, 689);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_116_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_116"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_116"), configuredFeature);
		}
	}
