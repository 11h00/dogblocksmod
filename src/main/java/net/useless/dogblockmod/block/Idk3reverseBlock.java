...
public class Idk3reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:idk_3reverse")
	public static final Block block = null;

	public Idk3reverseBlock(DogblockmodModElements instance) {
		super(instance, 1425);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(4f, 25f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("idk_3reverse");
		}
