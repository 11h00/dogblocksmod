...
public class Exdog3reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_3reverse")
	public static final Block block = null;

	public Exdog3reverseBlock(DogblockmodModElements instance) {
		super(instance, 848);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("exdog_3reverse");
		}
