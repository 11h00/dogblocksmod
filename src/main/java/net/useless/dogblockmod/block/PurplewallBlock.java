...
public class PurplewallBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:purplewall")
	public static final Block block = null;

	public PurplewallBlock(DogblockmodModElements instance) {
		super(instance, 1221);
	}
