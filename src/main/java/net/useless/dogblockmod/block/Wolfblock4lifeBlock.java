...
import net.useless.dogblockmod.procedures.Wolf4animationProcedure;
...
public class Wolfblock4lifeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:wolfblock_4life")
	public static final Block block = null;

	public Wolfblock4lifeBlock(DogblockmodModElements instance) {
		super(instance, 1173);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("wolfblock_4life");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Wolf4animationProcedure.executeProcedure(Stream
