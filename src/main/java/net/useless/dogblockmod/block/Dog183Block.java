...
public class Dog183Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_183")
	public static final Block block = null;

	public Dog183Block(DogblockmodModElements instance) {
		super(instance, 1483);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_183_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_183"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_183"), configuredFeature);
		}
	}
