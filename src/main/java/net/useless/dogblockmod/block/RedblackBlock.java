...
public class RedblackBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:redblack")
	public static final Block block = null;

	public RedblackBlock(DogblockmodModElements instance) {
		super(instance, 1261);
	}
