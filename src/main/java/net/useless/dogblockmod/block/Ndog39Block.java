...
public class Ndog39Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_39")
	public static final Block block = null;

	public Ndog39Block(DogblockmodModElements instance) {
		super(instance, 551);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_39_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_39"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_39"), configuredFeature);
		}
	}
