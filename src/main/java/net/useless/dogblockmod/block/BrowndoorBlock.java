...
import net.useless.dogblockmod.procedures.BrowndoorBlockAddedProcedure;
...
public class BrowndoorBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:browndoorbottom")
	public static final Block block = null;

	public BrowndoorBlock(DogblockmodModElements instance) {
		super(instance, 748);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("browndoorbottom");
		}
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			BrowndoorBlockAddedProcedure.executeProcedure(Stream
