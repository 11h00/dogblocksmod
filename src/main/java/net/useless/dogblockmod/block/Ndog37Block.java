...
public class Ndog37Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_37")
	public static final Block block = null;

	public Ndog37Block(DogblockmodModElements instance) {
		super(instance, 550);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_37_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_37"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_37"), configuredFeature);
		}
	}
