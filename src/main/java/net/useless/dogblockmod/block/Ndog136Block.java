...
public class Ndog136Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:ndog_136")
	public static final Block block = null;

	public Ndog136Block(DogblockmodModElements instance) {
		super(instance, 837);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:ndog_136_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("ndog_136"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:ndog_136"), configuredFeature);
		}
	}
