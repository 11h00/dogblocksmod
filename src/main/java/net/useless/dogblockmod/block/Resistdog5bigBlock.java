...
import net.useless.dogblockmod.procedures.Resistdog5bigBlockDestroyedByPlayerProcedure;
...
public class Resistdog5bigBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_5big")
	public static final Block block = null;

	public Resistdog5bigBlock(DogblockmodModElements instance) {
		super(instance, 804);
	}
