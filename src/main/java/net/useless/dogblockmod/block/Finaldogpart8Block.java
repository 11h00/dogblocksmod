...
public class Finaldogpart8Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_8")
	public static final Block block = null;

	public Finaldogpart8Block(DogblockmodModElements instance) {
		super(instance, 946);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_8");
		}
