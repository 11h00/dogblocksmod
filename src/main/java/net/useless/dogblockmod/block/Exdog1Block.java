...
import net.useless.dogblockmod.procedures.Exdog1BlockDestroyedByPlayerProcedure;
...
public class Exdog1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:exdog_1")
	public static final Block block = null;

	public Exdog1Block(DogblockmodModElements instance) {
		super(instance, 843);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Exdog1BlockDestroyedByPlayerProcedure.executeProcedure(Stream
