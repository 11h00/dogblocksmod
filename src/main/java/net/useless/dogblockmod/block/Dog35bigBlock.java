...
public class Dog35bigBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_35big")
	public static final Block block = null;

	public Dog35bigBlock(DogblockmodModElements instance) {
		super(instance, 290);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(300f, 45f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("dog_35big");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.COOKED_CHICKEN, (int) (35)));
		}
