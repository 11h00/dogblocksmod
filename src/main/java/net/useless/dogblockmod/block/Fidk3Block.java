...
public class Fidk3Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:fidk_3")
	public static final Block block = null;

	public Fidk3Block(DogblockmodModElements instance) {
		super(instance, 1426);
	}
