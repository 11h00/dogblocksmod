...
public class Dog150Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_150")
	public static final Block block = null;

	public Dog150Block(DogblockmodModElements instance) {
		super(instance, 869);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_150_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_150"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_150"), configuredFeature);
		}
	}
