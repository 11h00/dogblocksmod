...
public class ReverseFinaldogpart2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_2")
	public static final Block block = null;

	public ReverseFinaldogpart2Block(DogblockmodModElements instance) {
		super(instance, 949);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_2");
		}
