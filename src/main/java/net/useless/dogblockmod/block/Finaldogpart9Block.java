...
public class Finaldogpart9Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:finaldogpart_9")
	public static final Block block = null;

	public Finaldogpart9Block(DogblockmodModElements instance) {
		super(instance, 947);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("finaldogpart_9");
		}
