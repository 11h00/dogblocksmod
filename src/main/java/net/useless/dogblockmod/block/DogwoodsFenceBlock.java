...
public class DogwoodsFenceBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dogwoods_fence")
	public static final Block block = null;

	public DogwoodsFenceBlock(DogblockmodModElements instance) {
		super(instance, 507);
	}
	...
	public static class CustomBlock extends FenceBlock {
		public CustomBlock() {
			...
			setRegistryName("dogwoods_fence");
		}
