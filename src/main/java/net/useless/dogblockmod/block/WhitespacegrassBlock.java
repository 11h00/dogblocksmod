...
public class WhitespacegrassBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacegrass")
	public static final Block block = null;

	public WhitespacegrassBlock(DogblockmodModElements instance) {
		super(instance, 218);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("whitespacegrass");
		}
