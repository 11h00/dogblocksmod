...
public class PurpleholeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:purplehole")
	public static final Block block = null;

	public PurpleholeBlock(DogblockmodModElements instance) {
		super(instance, 1222);
	}
