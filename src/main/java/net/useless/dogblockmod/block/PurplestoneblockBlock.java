...
public class PurplestoneblockBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:purplestoneblock")
	public static final Block block = null;

	public PurplestoneblockBlock(DogblockmodModElements instance) {
		super(instance, 1238);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("purplestoneblock");
		}
