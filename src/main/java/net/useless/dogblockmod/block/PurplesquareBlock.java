...
public class PurplesquareBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:purplesquare")
	public static final Block block = null;

	public PurplesquareBlock(DogblockmodModElements instance) {
		super(instance, 1223);
	}
