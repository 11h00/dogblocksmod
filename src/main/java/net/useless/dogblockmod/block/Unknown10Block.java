...
public class Unknown10Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_10")
	public static final Block block = null;

	public Unknown10Block(DogblockmodModElements instance) {
		super(instance, 1270);
	}
