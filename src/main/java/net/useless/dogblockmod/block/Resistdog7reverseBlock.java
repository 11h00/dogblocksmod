...
public class Resistdog7reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_7reverse")
	public static final Block block = null;

	public Resistdog7reverseBlock(DogblockmodModElements instance) {
		super(instance, 930);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("resistdog_7reverse");
		}
