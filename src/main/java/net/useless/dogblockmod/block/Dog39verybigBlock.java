...
public class Dog39verybigBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_39verybig")
	public static final Block block = null;

	public Dog39verybigBlock(DogblockmodModElements instance) {
		super(instance, 304);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(1000f, 300f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dog_39verybig");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.EXPERIENCE_BOTTLE, (int) (50)));
		}
