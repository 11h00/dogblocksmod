...
public class Resistdog2reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_2reverse")
	public static final Block block = null;

	public Resistdog2reverseBlock(DogblockmodModElements instance) {
		super(instance, 726);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("resistdog_2reverse");
		}
