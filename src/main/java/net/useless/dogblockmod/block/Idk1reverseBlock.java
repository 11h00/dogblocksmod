...
public class Idk1reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:idk_1reverse")
	public static final Block block = null;

	public Idk1reverseBlock(DogblockmodModElements instance) {
		super(instance, 1418);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(5f, 25f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("idk_1reverse");
		}
