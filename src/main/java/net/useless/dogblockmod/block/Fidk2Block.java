...
public class Fidk2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:fidk_2")
	public static final Block block = null;

	public Fidk2Block(DogblockmodModElements instance) {
		super(instance, 1423);
	}
