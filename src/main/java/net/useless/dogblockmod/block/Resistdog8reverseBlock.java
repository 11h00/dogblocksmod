...
public class Resistdog8reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_8reverse")
	public static final Block block = null;

	public Resistdog8reverseBlock(DogblockmodModElements instance) {
		super(instance, 932);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("resistdog_8reverse");
		}
