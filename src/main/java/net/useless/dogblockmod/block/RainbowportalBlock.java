...
public class RainbowportalBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:rainbowportal")
	public static final Block block = null;

	public RainbowportalBlock(DogblockmodModElements instance) {
		super(instance, 968);
	}
