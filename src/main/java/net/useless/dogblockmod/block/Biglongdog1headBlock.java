...
public class Biglongdog1headBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:biglongdog_1head")
	public static final Block block = null;

	public Biglongdog1headBlock(DogblockmodModElements instance) {
		super(instance, 635);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(70f, 175f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("biglongdog_1head");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.BEEF, (int) (13)));
		}
