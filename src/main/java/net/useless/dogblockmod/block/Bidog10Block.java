...
import net.useless.dogblockmod.procedures.Bidog10EntityCollidesInTheBlockProcedure;
...
public class Bidog10Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bidog_10")
	public static final Block block = null;

	public Bidog10Block(DogblockmodModElements instance) {
		super(instance, 88);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(150f, 45f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("bidog_10");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.PORKCHOP, (int) (11)));
		}
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			Bidog10EntityCollidesInTheBlockProcedure.executeProcedure(Stream
