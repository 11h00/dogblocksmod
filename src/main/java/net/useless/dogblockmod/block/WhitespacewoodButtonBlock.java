...
public class WhitespacewoodButtonBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:whitespacewood_button")
	public static final Block block = null;

	public WhitespacewoodButtonBlock(DogblockmodModElements instance) {
		super(instance, 191);
	}
	...
	public static class CustomBlock extends WoodButtonBlock {
		public CustomBlock() {
			...
			setRegistryName("whitespacewood_button");
		}
