...
public class BrownsquareBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:brownsquare")
	public static final Block block = null;

	public BrownsquareBlock(DogblockmodModElements instance) {
		super(instance, 921);
	}
