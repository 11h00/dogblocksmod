...
public class Bossblock2life1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bossblock_2life_1")
	public static final Block block = null;

	public Bossblock2life1Block(DogblockmodModElements instance) {
		super(instance, 772);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("bossblock_2life_1");
		}
