...
public class ReverseFinaldogpart4Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:reverse_finaldogpart_4")
	public static final Block block = null;

	public ReverseFinaldogpart4Block(DogblockmodModElements instance) {
		super(instance, 951);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("reverse_finaldogpart_4");
		}
