...
public class BrownfloorunbreakableBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:brownfloorunbreakable")
	public static final Block block = null;

	public BrownfloorunbreakableBlock(DogblockmodModElements instance) {
		super(instance, 915);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			...
			setRegistryName("brownfloorunbreakable");
		}
