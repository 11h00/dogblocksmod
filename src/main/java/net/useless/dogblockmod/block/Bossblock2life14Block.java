...
import net.useless.dogblockmod.procedures.Bossblock2life14BlockDestroyedByPlayerProcedure;
...
public class Bossblock2life14Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:bossblock_2life_14")
	public static final Block block = null;

	public Bossblock2life14Block(DogblockmodModElements instance) {
		super(instance, 785);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(7.5f, 10f).setLightLevel(s -> 0).harvestLevel(1).harvestTool(ToolType.PICKAXE).setRequiresTool().notSolid()
					.setOpaque((bs, br, bp) -> false));
			setRegistryName("bossblock_2life_14");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Bossblock2life14BlockDestroyedByPlayerProcedure.executeProcedure(Stream
