...
public class Unknown2Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:unknown_2")
	public static final Block block = null;

	public Unknown2Block(DogblockmodModElements instance) {
		super(instance, 1262);
	}
