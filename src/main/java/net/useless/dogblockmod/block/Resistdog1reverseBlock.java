...
public class Resistdog1reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_1reverse")
	public static final Block block = null;

	public Resistdog1reverseBlock(DogblockmodModElements instance) {
		super(instance, 725);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("resistdog_1reverse");
		}
