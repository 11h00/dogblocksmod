...
public class Dog37Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_37")
	public static final Block block = null;

	public Dog37Block(DogblockmodModElements instance) {
		super(instance, 298);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.GOLDEN_CARROT, (int) (4)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_37_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_37"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_37"), configuredFeature);
		}
	}
