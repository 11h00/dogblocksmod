...
public class Dog34Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_34")
	public static final Block block = null;

	public Dog34Block(DogblockmodModElements instance) {
		super(instance, 261);
	...
	public static class CustomBlock extends FallingBlock {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Items.CARROT, (int) (7)));
		}
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("dogblockmod:dog_34_match"), () -> CustomRuleTest.codec);
			...
			event.getRegistry().register(feature.setRegistryName("dog_34"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("dogblockmod:dog_34"), configuredFeature);
		}
	}
