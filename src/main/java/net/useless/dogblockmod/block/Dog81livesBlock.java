...
public class Dog81livesBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:dog_81lives")
	public static final Block block = null;

	public Dog81livesBlock(DogblockmodModElements instance) {
		super(instance, 121);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK)
					...
					.hardnessAndResistance(40f, 3000f).setLightLevel(s -> 0).harvestLevel(2).harvestTool(ToolType.PICKAXE).setRequiresTool()
					.notSolid().setOpaque((bs, br, bp) -> false));
			setRegistryName("dog_81lives");
		}
