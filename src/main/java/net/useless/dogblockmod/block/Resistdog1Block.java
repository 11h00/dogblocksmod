...
import net.useless.dogblockmod.procedures.Resistdog1BlockDestroyedByPlayerProcedure;
...
public class Resistdog1Block extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_1")
	public static final Block block = null;

	public Resistdog1Block(DogblockmodModElements instance) {
		super(instance, 723);
	}
	...
	public static class CustomBlock extends FallingBlock {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Resistdog1BlockDestroyedByPlayerProcedure.executeProcedure(Stream
