...
public class Resistdog4reverseBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:resistdog_4reverse")
	public static final Block block = null;

	public Resistdog4reverseBlock(DogblockmodModElements instance) {
		super(instance, 742);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("resistdog_4reverse");
		}
