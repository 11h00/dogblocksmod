...
import net.useless.dogblockmod.procedures.Wolf1animationProcedure;
...
public class Wolfblock1lifeBlock extends DogblockmodModElements.ModElement {
	@ObjectHolder("dogblockmod:wolfblock_1life")
	public static final Block block = null;

	public Wolfblock1lifeBlock(DogblockmodModElements instance) {
		super(instance, 1177);
	}
	...
	public static class CustomBlock extends FallingBlock {
		public CustomBlock() {
			...
			setRegistryName("wolfblock_1life");
		}
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			Wolf1animationProcedure.executeProcedure(Stream
