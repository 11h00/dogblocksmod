...
import net.useless.dogblockmod.procedures.Floor03gsProcedure;
...
public class Floor03dimDimension extends DogblockmodModElements.ModElement {
	public Floor03dimDimension(DogblockmodModElements instance) {
		super(instance, 1319);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_03dim"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_03dim"))) {
