...
import net.useless.dogblockmod.procedures.Floor09gsProcedure;
...
public class Floor09Dimension extends DogblockmodModElements.ModElement {
	public Floor09Dimension(DogblockmodModElements instance) {
		super(instance, 1336);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_09"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_09"))) {
