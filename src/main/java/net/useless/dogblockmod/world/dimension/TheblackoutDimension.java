...
public class TheblackoutDimension extends DogblockmodModElements.ModElement {
	public TheblackoutDimension(DogblockmodModElements instance) {
		super(instance, 115);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(BlackstoneBlock.block);
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("dogblockmod:darkbiome")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:theblackout"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
