...
import net.useless.dogblockmod.procedures.HospitalzonegsProcedure;
...
public class HospitalzoneDimension extends DogblockmodModElements.ModElement {
	public HospitalzoneDimension(DogblockmodModElements instance) {
		super(instance, 1533);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("dogblockmod:hospitalzonebiome")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:hospitalzone"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:hospitalzone"))) {

			HospitalzonegsProcedure
