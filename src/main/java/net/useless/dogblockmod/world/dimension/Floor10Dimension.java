...
import net.useless.dogblockmod.procedures.Floor10gsProcedure;
...
public class Floor10Dimension extends DogblockmodModElements.ModElement {
	public Floor10Dimension(DogblockmodModElements instance) {
		super(instance, 1338);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_10"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_10"))) {
