...
import net.useless.dogblockmod.procedures.Redspace2genstructProcedure;
...
public class Redspace2Dimension extends DogblockmodModElements.ModElement {
	public Redspace2Dimension(DogblockmodModElements instance) {
		super(instance, 1633);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:redspace_2"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:redspace_2"))) {

			Redspace2genstructProcedure
