...
import net.useless.dogblockmod.procedures.GiantdoghomegsProcedure;
...
public class GiantdoghoomeDimension extends DogblockmodModElements.ModElement {
	public GiantdoghoomeDimension(DogblockmodModElements instance) {
		super(instance, 1542);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("dogblockmod:giantdoghomebiome")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:giantdoghoome"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:giantdoghoome"))) {

			GiantdoghomegsProcedure
