...
import net.useless.dogblockmod.procedures.Dogtrap2genstrucProcedure;
...
public class Dogtrap2Dimension extends DogblockmodModElements.ModElement {
	public Dogtrap2Dimension(DogblockmodModElements instance) {
		super(instance, 994);
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("dogblockmod:dogtrap_2biome")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:dogtrap_2"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:dogtrap_2"))) {

			Dogtrap2genstrucProcedure
