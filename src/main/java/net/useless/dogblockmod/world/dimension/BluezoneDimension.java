...
public class BluezoneDimension extends DogblockmodModElements.ModElement {
	public BluezoneDimension(DogblockmodModElements instance) {
		super(instance, 1299);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:bluezone"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
