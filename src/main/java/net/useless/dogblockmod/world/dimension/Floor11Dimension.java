...
import net.useless.dogblockmod.procedures.Floor11gsProcedure;
...
public class Floor11Dimension extends DogblockmodModElements.ModElement {
	public Floor11Dimension(DogblockmodModElements instance) {
		super(instance, 1340);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_11"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_11"))) {
