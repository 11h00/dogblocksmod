...
import net.useless.dogblockmod.procedures.Floor13gsProcedure;
...
public class Floor13Dimension extends DogblockmodModElements.ModElement {
	public Floor13Dimension(DogblockmodModElements instance) {
		super(instance, 1344);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_13"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_13"))) {
