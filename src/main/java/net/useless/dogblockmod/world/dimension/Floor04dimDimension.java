...
import net.useless.dogblockmod.procedures.Floor04gsProcedure;
...
public class Floor04dimDimension extends DogblockmodModElements.ModElement {
	public Floor04dimDimension(DogblockmodModElements instance) {
		super(instance, 1322);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_04dim"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_04dim"))) {
