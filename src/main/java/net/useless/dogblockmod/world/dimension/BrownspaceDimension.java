...
import net.useless.dogblockmod.procedures.BrownspacegenstrucProcedure;
...
public class BrownspaceDimension extends DogblockmodModElements.ModElement {
	public BrownspaceDimension(DogblockmodModElements instance) {
		super(instance, 997);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:brownspace"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:brownspace"))) {

			BrownspacegenstrucProcedure
