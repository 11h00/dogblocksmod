...
import net.useless.dogblockmod.procedures.Floor1enterProcedure;
...
public class Floor1Dimension extends DogblockmodModElements.ModElement {
	public Floor1Dimension(DogblockmodModElements instance) {
		super(instance, 230);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_1"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_1"))) {

			Floor1enterProcedure
