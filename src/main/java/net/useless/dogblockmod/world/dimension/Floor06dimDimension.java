...
import net.useless.dogblockmod.procedures.Floor06gsProcedure;
...
public class Floor06dimDimension extends DogblockmodModElements.ModElement {
	public Floor06dimDimension(DogblockmodModElements instance) {
		super(instance, 1328);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_06dim"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_06dim"))) {
