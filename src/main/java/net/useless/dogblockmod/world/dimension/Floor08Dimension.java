...
import net.useless.dogblockmod.procedures.Floor08gsProcedure;
...
public class Floor08Dimension extends DogblockmodModElements.ModElement {
	public Floor08Dimension(DogblockmodModElements instance) {
		super(instance, 1334);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_08"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_08"))) {
