...
import net.useless.dogblockmod.procedures.Floor05gsProcedure;
...
public class Floor05dimDimension extends DogblockmodModElements.ModElement {
	public Floor05dimDimension(DogblockmodModElements instance) {
		super(instance, 1325);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_05dim"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:floor_05dim"))) {
