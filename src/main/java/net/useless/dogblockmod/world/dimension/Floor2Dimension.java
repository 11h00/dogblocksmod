...
public class Floor2Dimension extends DogblockmodModElements.ModElement {
	public Floor2Dimension(DogblockmodModElements instance) {
		super(instance, 265);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		...
		replaceableBlocks.add(ForgeRegistries.BIOMES.getValue(new ResourceLocation("dogblockmod:floor_2biome")).getGenerationSettings()
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:floor_2"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
