...
import net.useless.dogblockmod.procedures.RedspacegenstructProcedure;
...
public class RedspaceDimension extends DogblockmodModElements.ModElement {
	public RedspaceDimension(DogblockmodModElements instance) {
		super(instance, 1003);
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("dogblockmod:redspace"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
	...
	public void onPlayerChangedDimensionEvent(PlayerEvent.PlayerChangedDimensionEvent event) {
		...
		if (event.getTo() == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("dogblockmod:redspace"))) {

			RedspacegenstructProcedure
