...
public class Dogtrap3biomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public Dogtrap3biomeBiome(DogblockmodModElements instance) {
		super(instance, 1540);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:dogtrap_3biome"));
			}
		}
	}
