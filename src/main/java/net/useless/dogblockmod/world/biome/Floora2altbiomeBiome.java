...
public class Floora2altbiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public Floora2altbiomeBiome(DogblockmodModElements instance) {
		super(instance, 746);
			...
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-1).setWaterColor(-1).setWaterFogColor(-1).withSkyColor(-1)
						.withFoliageColor(-1).withGrassColor(-1).setAmbientSound((net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS
								.getValue(new ResourceLocation("dogblockmod:floora2altbgm")))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:floora_2altbiome"));
			}
		}
	}
