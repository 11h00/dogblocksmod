...
public class CorruptionbiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public CorruptionbiomeBiome(DogblockmodModElements instance) {
		super(instance, 1326);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-6750208).setWaterColor(-6750208).setWaterFogColor(-6750208)
						...
						.setAmbientSound(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dogblockmod:bgmfloor02")))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:corruptionbiome"));
			}
		}
	}
