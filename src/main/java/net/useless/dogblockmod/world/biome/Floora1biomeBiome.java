...
public class Floora1biomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public Floora1biomeBiome(DogblockmodModElements instance) {
		super(instance, 733);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16777216).setWaterColor(-16777216).setWaterFogColor(-16777216)
						...
						.setAmbientSound(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dogblockmod:floora1bgm")))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:floora_1biome"));
			}
		}
	}
