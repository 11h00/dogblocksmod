...
public class GiantdoghomebiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public GiantdoghomebiomeBiome(DogblockmodModElements instance) {
		super(instance, 1543);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:giantdoghomebiome"));
			}
		}
	}
