...
public class DogbiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public DogbiomeBiome(DogblockmodModElements instance) {
		super(instance, 501);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(DogdimgrassBlock.block.getDefaultState(),
								DogdimgrassBlock.block.getDefaultState(), DogdimgrassBlock.block.getDefaultState())));
								...
								Feature.DISK
										.withConfiguration(
												new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
														ImmutableList.of(DogdimgrassBlock.block.getDefaultState(),
																DogdimgrassBlock.block.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:dogbiome"));
			}
		}
	}
