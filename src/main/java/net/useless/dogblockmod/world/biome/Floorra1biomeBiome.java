...
public class Floorra1biomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public Floorra1biomeBiome(DogblockmodModElements instance) {
		super(instance, 976);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:floorra_1biome"));
			}
		}
	}
