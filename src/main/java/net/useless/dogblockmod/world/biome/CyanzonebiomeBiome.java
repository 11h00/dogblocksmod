...
public class CyanzonebiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public CyanzonebiomeBiome(DogblockmodModElements instance) {
		super(instance, 1528);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:cyanzonebiome"));
			}
		}
	}
