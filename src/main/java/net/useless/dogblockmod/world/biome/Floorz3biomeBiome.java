...
public class Floorz3biomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public Floorz3biomeBiome(DogblockmodModElements instance) {
		super(instance, 711);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16711681).setWaterColor(-16711681).setWaterFogColor(-16711681)
						...
						.setAmbientSound(
								(net.minecraft.util.SoundEvent) ForgeRegistries.SOUND_EVENTS.getValue(new ResourceLocation("dogblockmod:fz3bgm")))
						.build();
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:floorz_3biome"));
			}
		}
	}
