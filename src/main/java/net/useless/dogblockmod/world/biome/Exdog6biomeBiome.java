...
public class Exdog6biomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public Exdog6biomeBiome(DogblockmodModElements instance) {
		super(instance, 936);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				BiomeGenerationSettings.Builder biomeGenerationSettings = new BiomeGenerationSettings.Builder()
						.withSurfaceBuilder(SurfaceBuilder.DEFAULT.func_242929_a(new SurfaceBuilderConfig(Resistdog6Block.block.getDefaultState(),
								Resistdog6Block.block.getDefaultState(), Resistdog6Block.block.getDefaultState())));
				...
				biomeGenerationSettings.withFeature(GenerationStage.Decoration.VEGETAL_DECORATION, Feature.TREE
						.withConfiguration((new BaseTreeFeatureConfig.Builder(new SimpleBlockStateProvider(Resistdog6Block.block.getDefaultState()),
								new SimpleBlockStateProvider(Resistdog6Block.block.getDefaultState()),
								...
								Feature.DISK
										.withConfiguration(
												new SphereReplaceConfig(Blocks.SAND.getDefaultState(), FeatureSpread.func_242253_a(2, 4), 2,
														ImmutableList.of(Resistdog6Block.block.getDefaultState(),
																Resistdog6Block.block.getDefaultState())))
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:exdog_6biome"));
			}
		}
	}
