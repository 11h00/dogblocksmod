...
public class BluezonebiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public BluezonebiomeBiome(DogblockmodModElements instance) {
		super(instance, 1314);
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				BiomeAmbience effects = new BiomeAmbience.Builder().setFogColor(-16776961).setWaterColor(-16776961).setWaterFogColor(-16776961)
						.withSkyColor(-16776961).withFoliageColor(-16776961).withGrassColor(-16776961)
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:bluezonebiome"));
			}
		}
	}
