...
public class DogtrapbiomeBiome extends DogblockmodModElements.ModElement {
	public static Biome biome;

	public DogtrapbiomeBiome(DogblockmodModElements instance) {
		super(instance, 824);
	...
	private static class BiomeRegisterHandler {
		...
		public void registerBiomes(RegistryEvent.Register<Biome> event) {
			if (biome == null) {
				...
				event.getRegistry().register(biome.setRegistryName("dogblockmod:dogtrapbiome"));
			}
		}
	}
